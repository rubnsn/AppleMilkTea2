## AppleMilkTea2 1.7.10 NH_based

### 動作環境:
・Minecraft 1.7.10
<br>・MinecraftForge 10.13.4.1614
<br>・EndlessIDs 1.7.4+
...
### 注意事項
・2.10aより、1.7.10のモダン環境に対応するため、GTNewHorizons/ExampleModをベースに環境構築し、PotionID拡張のためにEndlessIDsを採用しました。
<br> モダン化の作業を行ってくださったerialsan氏に深く感謝申し上げます。
<br>・このファイル群には、コンパイルに必要な他MOD様のAPIが含まれていません。
<br>　よってこのままIDE等に落としこんでもPluginクラス群がエラーを吐きますのでご注意下さい。
<br>　（再入手が難しいmodパッケージが数点ありますのでご注意ください。）
