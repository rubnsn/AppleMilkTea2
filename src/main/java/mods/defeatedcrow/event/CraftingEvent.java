    ...
    public void onCraftingEvent(PlayerEvent.ItemCraftedEvent event) {
        ...
        if (crafting != null) {
            if (crafting.getItem() == Item.getItemFromBlock(DCsAppleMilk.teaMakerNext)) {
                ...
                if (crafting.getItem() == Item.getItemFromBlock(DCsAppleMilk.cLamp) && crafting.getItemDamage() == 5) {
        ...
        for (int i = 0; i < craftMatrix.getSizeInventory(); i++) {
            ...
            if (m != null && m.getItem() == Items.potionitem
                && (crafting.getItem() == Item.getItemFromBlock(DCsAppleMilk.teacupBlock)
                    || crafting.getItem() == Item.getItemFromBlock(DCsAppleMilk.teaCup2))) {
