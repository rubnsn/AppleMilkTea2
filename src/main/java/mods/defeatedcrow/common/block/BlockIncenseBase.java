...
public class BlockIncenseBase extends BlockContainer {
        ...
        if (tile != null) {
            ...
            if (ash != null) {
                ...
                if (ash.hasTagCompound()) {
                    entityitem2.getEntityItem()
                        .setTagCompound(
                            (NBTTagCompound) ash.getTagCompound()
                                .copy());
                }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (tile != null) {
            b = tile.getActive();
            if (b) {
                if (tile.hasItem() && tile.getItemstack()
                    .getItem() instanceof IIncenseEffect) {
                    IIncenseEffect incense = (IIncenseEffect) tile.getItemstack()
                        .getItem();
