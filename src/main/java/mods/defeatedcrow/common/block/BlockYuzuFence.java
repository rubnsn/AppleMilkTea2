...
public class BlockYuzuFence extends Block {
    ...
    public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB aabb, List list,
        ...
        if (north) {
            AxisAlignedBB aabbN = AxisAlignedBB.getBoundingBox(
                (double) (x + f1),
                (double) (y),
                (double) (z + 0.0F),
                (double) (x + f2),
        ...
        if (south) {
            AxisAlignedBB aabbS = AxisAlignedBB.getBoundingBox(
                (double) (x + f1),
                (double) (y),
                (double) (z + f2),
                (double) (x + f2),
        ...
        if (west) {
            AxisAlignedBB aabbW = AxisAlignedBB.getBoundingBox(
                (double) (x),
                (double) (y),
                (double) (z + f1),
                (double) (x + f2),
        ...
        if (east) {
            AxisAlignedBB aabbE = AxisAlignedBB.getBoundingBox(
                (double) (x + f2),
                (double) (y),
                (double) (z + f1),
                (double) (x + 1),
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
        if (par5Entity instanceof EntityLiving && !(par5Entity instanceof EntityPlayer)
            && !(par5Entity instanceof EntityTameable)
            && !(par5Entity instanceof EntityVillager)
