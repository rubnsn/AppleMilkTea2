...
public class BlockBarrel extends BlockContainer {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
        ...
        if (Util.notEmptyItem(item) && tile.getAged()) {
            ...
            if (Util.notEmptyItem(item) && DCsAppleMilk.debugMode && item.getItem() == DCsAppleMilk.chalcedonyKnife) {
                ...
                if (!par1World.isRemote) {
                    ...
                    if (flag2) {
                        par5EntityPlayer
                            .addChatMessage(new ChatComponentText("This place is not suitable for brewing."));
                    }
                }
                return true;
            }
