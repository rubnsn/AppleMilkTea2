...
/**
 * WT-A 1.20.1 mojmap migration for EntityItemTeaCup.
 * Original 1.7.10 logic preserved as TODO; stub compiles under Forge 47 + mojmap.
 * Properties are supplied by ModBlocks (BlockBehaviour.Properties.of()...).
 * Textures: JSON models under assets/defeatedcrow/models/block/ + blockstates/
 */
public class EntityItemTeaCup extends Block {

    public EntityItemTeaCup(BlockBehaviour.Properties properties) {
        super(properties);
    }
     ...
     *             id[0] = Potion.nightVision.id;
     * ... (full original retained in git history: git show HEAD:"src/main/java/mods/defeatedcrow/common/block/edible/EntityItemTeaCup.java")
     */
}
