...
public class BlockClamSand extends Block implements IRightClickHarvestable {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (!par1World.isRemote && par1World.rand.nextInt(r) == 0) {
            ...
            // 座標が増殖可能な状態か？
            boolean flag3 = par1World.getBlock(X1, Y1 + 1, Z1)
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        boolean flag = par1World.getBlock(par2, par3 + 1, par4)
            .getMaterial() == Material.water;
        ...
        if (l == 2) {
            for (int j = 1; j < 5; j++) {
                if (par1World.getBlock(par2, par3 + j, par4)
                    .getMaterial() == Material.water) k++;
            }
