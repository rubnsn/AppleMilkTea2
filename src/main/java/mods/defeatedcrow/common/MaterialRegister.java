...
public class MaterialRegister {
    ...
    public void load() {
        ...
        GameRegistry.registerBlock(
            DCsAppleMilk.gunpowderContainer,
            ItemGunpowderContainer.class,
        ...
        GameRegistry
            .registerBlock(DCsAppleMilk.containerWBottle, ItemContainerBase.class, "defeatedcrow.containerBottleW");
        GameRegistry
            .registerBlock(DCsAppleMilk.containerSaddle, ItemContainerBase.class, "defeatedcrow.containerSaddle");
        ...
        GameRegistry
            .registerBlock(DCsAppleMilk.blockDummyAlcohol, ItemDummyFluid.class, "defeatedcrow.blockDummyAlcohol");
        GameRegistry
            .registerBlock(DCsAppleMilk.blockDummyAlcohol2, ItemDummyFluid2.class, "defeatedcrow.blockDummyAlcohol2");
    ...
    public boolean addPotion() {
        int lim = 128;
        if (Potion.potionTypes.length < lim) return false;
        // ポーション効果の追加
        ...
        if (Potion.potionTypes[DCsConfig.potionIDPrvExplode] == null && DCsConfig.potionIDPrvExplode < lim) {
            DCsAppleMilk.prvExplode = (new PotionProtectionEX(
                DCsConfig.potionIDPrvExplode,
                false,
                0x646464,
                false,
                true,
                ...
                DamageSource.anvil,
                2,
                0)).setPotionName("DCs.potion.protectionExplode");
        }
        if (Potion.potionTypes[DCsConfig.potionIDPrvProjectile] == null && DCsConfig.potionIDPrvProjectile < lim) {
            DCsAppleMilk.prvProjectile = (new PotionProtectionEX(
                DCsConfig.potionIDPrvProjectile,
                false,
                0x996420,
                false,
                false,
                ...
                DamageSource.magic,
                1,
                0)).setPotionName("DCs.potion.protectionProjectile");
        }
        ...
        if (Potion.potionTypes[DCsConfig.potionIDPrvSuffocation] == null && DCsConfig.potionIDPrvSuffocation < lim) {
            DCsAppleMilk.prvSuffocation = (PotionProtectionEX) (new PotionProtectionEX(
                DCsConfig.potionIDPrvSuffocation,
                true,
                0xC064FF,
                false,
                false,
        ...
        if (Potion.potionTypes[DCsConfig.potionIDHallucinations] == null && DCsConfig.potionIDHallucinations < lim) {
            DCsAppleMilk.hallucinations = new PotionHallucination(
                DCsConfig.potionIDHallucinations,
                true,
                0xFF32FF,
                0,
    ...
    public void addFluid() {
        // vegi
        registerVegiOil = new Fluid("vegitable_oil").setDensity(800)
            .setViscosity(1500);
        ...
        // camellia
        registerCamOil = new Fluid("camellia_oil").setDensity(800)
            .setViscosity(1500);
        ...
        if (DCsAppleMilk.blockCamelliaOil != null) {
            ...
            FluidContainerRegistry.registerFluidContainer(
                FluidRegistry.getFluidStack("camellia_oil", FluidContainerRegistry.BUCKET_VOLUME),
                new ItemStack(DCsAppleMilk.bucketCamOil),
                new ItemStack(Items.bucket));
        ...
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("shothu_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.bucketYoungAlcohol, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("whiskey_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.bucketYoungAlcohol, 1, 1),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("brandy_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.bucketYoungAlcohol, 1, 2),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("rum_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.bucketYoungAlcohol, 1, 3),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("vodka_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.bucketYoungAlcohol, 1, 4),
            new ItemStack(Items.bucket));

        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("sake_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.moromi, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("beer_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.moromi, 1, 1),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("wine_young", FluidContainerRegistry.BUCKET_VOLUME),
            new ItemStack(DCsAppleMilk.moromi, 1, 2),
            new ItemStack(Items.bucket));

        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("shothu_dc", 200),
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 48),
            new ItemStack(Item.getItemFromBlock(DCsAppleMilk.emptyBottle)));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("whiskey_dc", 200),
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 55),
            new ItemStack(Item.getItemFromBlock(DCsAppleMilk.emptyBottle)));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("brandy_dc", 200),
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 56),
            new ItemStack(Item.getItemFromBlock(DCsAppleMilk.emptyBottle)));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("rum_dc", 200),
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 53),
            new ItemStack(Item.getItemFromBlock(DCsAppleMilk.emptyBottle)));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("vodka_dc", 200),
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 54),
            new ItemStack(Item.getItemFromBlock(DCsAppleMilk.emptyBottle)));

        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("sake_dc", 200),
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 49),
            new ItemStack(Item.getItemFromBlock(DCsAppleMilk.emptyBottle)));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("beer_dc", 200),
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 50),
            new ItemStack(Item.getItemFromBlock(DCsAppleMilk.emptyBottle)));
        FluidContainerRegistry.registerFluidContainer(
            FluidRegistry.getFluidStack("wine_dc", 200),
    ...
    static void addTools() {
        DCsAppleMilk.DCgrater = (new ItemGrater()).setUnlocalizedName("defeatedcrow.grater")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.chopsticks = (new ItemChopsticks()).setUnlocalizedName("defeatedcrow.chopsticks")
        ...
        DCsAppleMilk.monocle = (new ItemChalcedonyMonocle(
            ItemArmor.ArmorMaterial.IRON,
            DCsAppleMilk.proxy.addArmor("monocle"),
            0)).setUnlocalizedName("defeatedcrow.monocle")
                .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.onixSword = (new ItemOnixSword()).setUnlocalizedName("defeatedcrow.onixSword")
            .setCreativeTab(DCsAppleMilk.applemilk);
    ...
    static void addFoods() {
        ...
        DCsAppleMilk.appleTart = (new ItemAppleTart()).setUnlocalizedName("defeatedcrow.appleTart")
            .setCreativeTab(DCsAppleMilk.applemilkFood);
        ...
        DCsAppleMilk.foodTea = (new ItemFoodTea()).setUnlocalizedName("defeatedcrow.foodTea")
        ...
        DCsAppleMilk.yeast = (new ItemYeast()).setUnlocalizedName("defeatedcrow.yeast")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.moromi = (new ItemMoromi()).setUnlocalizedName("defeatedcrow.moromi")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.EXItems = (new ItemEXItem()).setUnlocalizedName("defeatedcrow.extraItems")
            .setCreativeTab(DCsAppleMilk.applemilkMaterial);
        ...
        DCsAppleMilk.bowlBlock = (new BlockBowl()).setBlockName("defeatedcrow.bowlBlock")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.bowlJP = (new BlockBowlJP()).setBlockName("defeatedcrow.bowlBlockJP")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.foodPlate = (new BlockFoodPlate()).setBlockName("defeatedcrow.foodPlate")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.chocoBlock = (new BlockChocoGift()).setBlockName("defeatedcrow.chocolateGift")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.teacupBlock = (new BlockFilledCup()).setBlockName("defeatedcrow.filledCup")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.teaCup2 = (new BlockFilledCup2()).setBlockName("defeatedcrow.filledCup2")
            .setCreativeTab(DCsAppleMilk.applemilkFood);
        ...
        DCsAppleMilk.blockIcecream = (new BlockIceCream()).setBlockName("defeatedcrow.iceCreamBlock")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.alcoholCup = (new BlockAlcoholCup()).setBlockName("defeatedcrow.alcoholCup")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.cocktail = (new BlockCocktail()).setBlockName("defeatedcrow.cocktail")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.cocktail2 = (new BlockCocktail2()).setBlockName("defeatedcrow.cocktail2")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.cocktailSP = (new BlockCocktailSP()).setBlockName("defeatedcrow.cocktailSP")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.emptyBottle = (new BlockEmptyBottle()).setBlockName("defeatedcrow.emptyBottle")
            .setCreativeTab(DCsAppleMilk.applemilk);
        ...
        DCsAppleMilk.barrel = (new BlockBarrel()).setBlockName("defeatedcrow.blockBarrel")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.itemCordial = (new ItemCordial()).setUnlocalizedName("defeatedcrow.itemCordial")
            .setCreativeTab(DCsAppleMilk.applemilk);
    ...
    static void addContainers() {
        DCsAppleMilk.woodBox = (new BlockWoodBox()).setBlockName("defeatedcrow.WoodBox")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.appleBox = (new BlockAppleBox()).setBlockName("defeatedcrow.appleBox")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.vegiBag = (new BlockVegiBag()).setBlockName("defeatedcrow.vegiBag")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.cardboard = (new BlockCardboard()).setBlockName("defeatedcrow.cardboardBox")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);
        ...
        DCsAppleMilk.mobBlock = (new BlockMobDrop()).setBlockName("defeatedcrow.mobDropBox")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.mushroomBox = (new BlockMushBox()).setBlockName("defeatedcrow.mushroomBox")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.eggBasket = (new BlockEggBasket()).setBlockName("defeatedcrow.eggBasket")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.melonBomb = (new BlockMelonBomb()).setBlockName("defeatedcrow.compressedMelon")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.silkyMelon = (new BlockSilkyMelon()).setBlockName("defeatedcrow.compressedSilkyMelon")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.wipeBox = (new BlockWipeBox()).setBlockName("defeatedcrow.wipeBox")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.wipeBox2 = (new BlockWipeBox2()).setBlockName("defeatedcrow.wipeBox2");

        DCsAppleMilk.flowerPot = (new BlockFlowerPot()).setBlockName("defeatedcrow.flowerPot")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);
        ...
        DCsAppleMilk.containerItemDoorW = (new ItemContainerDoor(Blocks.wooden_door))
            ...
            .setTextureName("defeatedcrow:containeritem_doorW")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.containerItemDoorI = (new ItemContainerDoor(Blocks.iron_door))
            .setUnlocalizedName("defeatedcrow.containeritemDoorI")
            .setTextureName("defeatedcrow:containeritem_doorI")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.flowerBase = (new BlockFlowerVase()).setBlockName("defeatedcrow.flowerVase")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.hedge = (new BlockHedge()).setBlockName("defeatedcrow.hedge")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

    }

    static void addDecorations() {
        DCsAppleMilk.bowlRack = (new BlockBowlRack()).setBlockName("defeatedcrow.bowlRack")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.Basket = (new BlockBasket()).setBlockName("defeatedcrow.basket")
            .setCreativeTab(DCsAppleMilk.applemilk);
        ...
        DCsAppleMilk.rotaryDial = (new BlockRotaryDial()).setBlockName("defeatedcrow.rotaryDial")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.chalcenonyPanel = (new BlockCPanel()).setBlockName("defeatedcrow.chalcedonyPanel")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.yuzuFence = (new BlockYuzuFence()).setBlockName("defeatedcrow.yuzuFence")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.woodPanel = (new BlockWoodPanel()).setBlockName("defeatedcrow.woodPanel")
            .setCreativeTab(DCsAppleMilk.applemilkContainer);

        DCsAppleMilk.crowDoll = (new BlockCrowDoll()).setBlockName("defeatedcrow.crowFigure")
            .setCreativeTab(DCsAppleMilk.applemilk);
    }

    static void addPlants() {
        DCsAppleMilk.leafTea = (new ItemLeafTea()).setUnlocalizedName("defeatedcrow.leafTea")
            .setCreativeTab(DCsAppleMilk.applemilkMaterial);
        ...
        DCsAppleMilk.saplingTea = (new BlockSaplingTea()).setBlockName("defeatedcrow.saplingTea")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.teaTree = (new BlockTeaTree()).setBlockName("defeatedcrow.teaTree")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.saplingYuzu = (new BlockYuzuSapling()).setBlockName("defeatedcrow.saplingYuzu")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.logYuzu = (new BlockYuzuLog()).setBlockName("defeatedcrow.logYuzu")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.leavesYuzu = (new BlockYuzuLeaves()).setBlockName("defeatedcrow.leavesYuzu")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.cassisTree = (new BlockCassisTree()).setBlockName("defeatedcrow.cassisTree")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.cropMint = (new BlockMintCrop()).setBlockName("defeatedcrow.cropMint");

        DCsAppleMilk.clam = (new ItemClam()).setUnlocalizedName("defeatedcrow.clam")
            .setCreativeTab(DCsAppleMilk.applemilkFood);

        DCsAppleMilk.princessClam = (new ItemPrincessClam()).setUnlocalizedName("defeatedcrow.princessClam")
            .setCreativeTab(DCsAppleMilk.applemilkMagic);

        DCsAppleMilk.clamSand = (new BlockClamSand()).setBlockName("defeatedcrow.clamSand")
            .setCreativeTab(DCsAppleMilk.applemilk);
    }

    static void addMaterials() {
        DCsAppleMilk.icyCrystal = (new ItemIcyCrystal()).setUnlocalizedName("defeatedcrow.icyCrystal")
            .setCreativeTab(DCsAppleMilk.applemilkMaterial);

        DCsAppleMilk.inkStick = (new ItemInkStick()).setUnlocalizedName("defeatedcrow.inkStick")
            .setCreativeTab(DCsAppleMilk.applemilkMaterial);

        DCsAppleMilk.stickCarbon = (new ItemCarbonStick()).setUnlocalizedName("defeatedcrow.stickCarbon")
            .setCreativeTab(DCsAppleMilk.applemilkMaterial);

        DCsAppleMilk.oreDust = (new ItemOreDust()).setUnlocalizedName("defeatedcrow.oreDust")
            .setCreativeTab(DCsAppleMilk.applemilkMaterial);
    ...
    static void addMachines() {
        DCsAppleMilk.teaMakerNext = (new BlockTeaMakerNext()).setBlockName("defeatedcrow.teaMakerNext")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.teaMakerBlack = (new BlockTeaMakerBlack()).setBlockName("defeatedcrow.teaMakerBlack")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.emptyCup = (new BlockEmptyCup()).setBlockName("defeatedcrow.emptyCup")
            .setCreativeTab(DCsAppleMilk.applemilk);
        ...
        DCsAppleMilk.emptyPanGaiden = (new BlockEmptyPanG()).setBlockName("defeatedcrow.soupPanG")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.filledSoupPan = (new BlockFilledSoupPan()).setBlockName("defeatedcrow.filledSoupPan");

        DCsAppleMilk.teppanII = (new BlockTeppanII()).setBlockName("defeatedcrow.cookingIronPlateII")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.iceMaker = (new BlockIceMaker()).setBlockName("defeatedcrow.iceMaker")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.processor = (new BlockProcessor()).setBlockName("defeatedcrow.processor")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.advProcessor = (new BlockAdvProcessor()).setBlockName("defeatedcrow.advProcessor")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.evaporator = (new BlockEvaporator()).setBlockName("defeatedcrow.evaporator")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.slotPanel = (new ItemSlotPanel()).setUnlocalizedName("defeatedcrow.slotPanel")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.jawPlate = (new ItemJawplate()).setUnlocalizedName("defeatedcrow.jawPlate")
            .setCreativeTab(DCsAppleMilk.applemilk);

        // エネルギー
        DCsAppleMilk.batteryItem = (new ItemBattery()).setUnlocalizedName("defeatedcrow.battery")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.yuzuBat = (new BlockYuzuBat()).setBlockName("defeatedcrow.yuzuBatContainer")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.gelBat = (new BlockGelBat()).setBlockName("defeatedcrow.gelBatContainer")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.redGel = (new BlockRedGel()).setBlockName("defeatedcrow.redGel")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.yuzuGel = (new BlockYuzuLight()).setBlockName("defeatedcrow.lightGel")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.batBox = (new BlockBatBox()).setBlockName("defeatedcrow.batBox")
            .setCreativeTab(DCsAppleMilk.applemilk);

        DCsAppleMilk.handleEngine = (new BlockHandleEngine()).setBlockName("defeatedcrow.EHandle")
            .setCreativeTab(DCsAppleMilk.applemilk);
        ...
        DCsAppleMilk.dustWood = (new ItemWoodDust()).setUnlocalizedName("defeatedcrow.dustWood")
            .setCreativeTab(DCsAppleMilk.applemilkMaterial);

        DCsAppleMilk.incenseBase = (new BlockIncenseBase()).setBlockName("defeatedcrow.incenseBase")
            .setCreativeTab(DCsAppleMilk.applemilkMagic);
        ...
        DCsAppleMilk.incenseIce = (ItemIncenseIce) (new ItemIncenseIce()).setUnlocalizedName("defeatedcrow.incense_ice")
            .setCreativeTab(DCsAppleMilk.applemilkMagic);
        ...
        DCsAppleMilk.incenseVanilla = (ItemIncenseVanilla) (new ItemIncenseVanilla())
            .setUnlocalizedName("defeatedcrow.incense_vanilla")
            .setCreativeTab(DCsAppleMilk.applemilkMagic);
