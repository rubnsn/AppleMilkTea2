...
@Mod(
    ...
    dependencies = "required-after:Forge@[10.13.4.1448,);required-after:endlessids")
public class DCsAppleMilk {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        // EndlessIDs is required-after; FML refuses load if missing.
