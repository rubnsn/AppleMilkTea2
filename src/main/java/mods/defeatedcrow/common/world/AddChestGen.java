...
public class AddChestGen {
    ...
    public void addChestItems() {
        ...
        for (String category : categoryA) {
            ...
            dungeon
                .addItem(new WeightedRandomChestContent(new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 19), 1, 1, 10));
            dungeon
                .addItem(new WeightedRandomChestContent(new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 18), 1, 1, 10));
            dungeon
                .addItem(new WeightedRandomChestContent(new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 0), 1, 1, 20));
        ...
        for (String category : categoryB) {
            ...
            // addItemメソッドで新しいアイテムを追加
            dungeon2
                .addItem(new WeightedRandomChestContent(new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 22), 1, 1, 10));
            dungeon2
                .addItem(new WeightedRandomChestContent(new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 23), 1, 1, 10));
