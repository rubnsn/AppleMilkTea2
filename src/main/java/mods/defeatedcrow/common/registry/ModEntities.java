...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<mods.defeatedcrow.common.entity.dummy.EntityStunEffect>> STUN_EFFECT = ENTITIES.register("stun_effect",
        () -> EntityType.Builder.<mods.defeatedcrow.common.entity.dummy.EntityStunEffect>of(mods.defeatedcrow.common.entity.dummy.EntityStunEffect::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(8).updateInterval(10).build("stun_effect"));
    ...
    public static final RegistryObject<EntityType<mods.defeatedcrow.common.entity.EntityYuzuBullet>> YUZU_BULLET = ENTITIES.register("yuzu_bullet",
        () -> EntityType.Builder.<mods.defeatedcrow.common.entity.EntityYuzuBullet>of(mods.defeatedcrow.common.entity.EntityYuzuBullet::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(8).updateInterval(10).build("yuzu_bullet"));

    // --- WT-B: Placeable 13 (edible blocks as entities for placement) ---
    public static final RegistryObject<EntityType<mods.defeatedcrow.common.entity.edible.PlaceableAlcoholCup>> PLACEABLE_ALCOHOL_CUP = ENTITIES.register("placeable_alcohol_cup",
        () -> EntityType.Builder.<mods.defeatedcrow.common.entity.edible.PlaceableAlcoholCup>of(mods.defeatedcrow.common.entity.edible.PlaceableAlcoholCup::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(10).updateInterval(20).build("placeable_alcohol_cup"));
