    ...
    public void config(Configuration cfg) {
        try {
            ...
            cfg.addCustomCategoryComment(
                "cocktail_1",
                "You can edit the information of the original cocktails." + BR
                    ...
                    + BR
                    + "If you want to use mod items, describe the following: \"modid:itemname:metadata\"."
                    + BR
                    + "If your description was wrong, it will be clam.");
            ...
            Property type1 = cfg
                .get("cocktail_1", "Cocktail Glass Type", type[0], "Coose cocktail type. 0:short 1:long 2:wineglass");
            Property deco1 = cfg.get(
                "cocktail_1",
                "Cocktail Decoration Type",
                deco[0],
            ...
            Property type2 = cfg
                .get("cocktail_1", "Cocktail Glass Type", type[1], "Coose cocktail type. 0:short 1:long 2:wineglass");
            Property deco2 = cfg.get(
                "cocktail_1",
                "Cocktail Decoration Type",
                deco[1],
                "Coose cocktail decoration. 0:none 1:lemon 2:lime 3:pine 4:apple");
            ...
            Property type3 = cfg
                .get("cocktail_3", "Cocktail Glass Type", type[2], "Coose cocktail type. 0:short 1:long 2:wineglass");
            Property deco3 = cfg.get(
                "cocktail_3",
                "Cocktail Decoration Type",
                deco[2],
                "Coose cocktail decoration. 0:none 1:lemon 2:lime 3:pine 4:apple");
