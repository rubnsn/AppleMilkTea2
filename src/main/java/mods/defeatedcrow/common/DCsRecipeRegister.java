...
public class DCsRecipeRegister {
    ...
    public void addRecipe() {
        // TagHelper.registerOre (datapack)("dustSugar", new ItemStack(Items.sugar, 1, 0));
        // TagHelper.registerOre (datapack)("foodSugar", new ItemStack(Items.sugar, 1, 0));
        // TagHelper.registerOre (datapack)("cropWheat", new ItemStack(Items.wheat, 1, 0));
        // TagHelper.registerOre (datapack)("cropApple", new ItemStack(Items.apple, 1, 0));
        // TagHelper.registerOre (datapack)("foodEgg", new ItemStack(Items.egg, 1, 0));
        // TagHelper.registerOre (datapack)("bucketWater", new ItemStack(Items.water_bucket, 1, 0));
        // TagHelper.registerOre (datapack)("bucketMilk", new ItemStack(Items.milk_bucket, 1, 0));
        // TagHelper.registerOre (datapack)("bucketLava", new ItemStack(Items.lava_bucket, 1, 0));
        // TagHelper.registerOre (datapack)("gemCoal", new ItemStack(Items.coal, 1, 0));
        ...
        RegistryHelper.addRecipe(
            new ShapedRecipe(
                ...
                new Object[] { " X ", "ZYZ", "XWX", Character.valueOf('W'), "gearIron", Character.valueOf('Z'),
                    new ItemStack(Items.glass_bottle, 1), Character.valueOf('Y'), "bucketLava", Character.valueOf('X'),
    ...
    static void addContainerRecipe() {
        ...
        // 迚ｹ谿翫さ繝ｳ繝・リ
        Item[] rets = { Item.getItemFromBlock(DCsAppleMilk.containerWBottle),
            Item.getItemFromBlock(DCsAppleMilk.containerSaddle), DCsAppleMilk.containerItemDoorW,
    ...
    static void addCordial() {// 驟貞挨縺ｫ繝ｬ繧ｷ繝斐′縺ゅｊ縲・㍼縺悟､壹＞縺ｮ縺ｧ縲’or譁・〒蝗槭＠縺､縺､蛟句挨繝｡繧ｽ繝・ラ繧堤畑諢上＠縺・
    ...
    static void addMachines() {
        ...
        RegistryHelper.addRecipe(
            new ShapedRecipe(
                ...
                new Object[] { "ZXZ", "ZYZ", "ZWZ", Character.valueOf('W'), new ItemStack(DCsAppleMilk.gelBat, 1, 0),
                    Character.valueOf('Z'), new ItemStack(Items.iron_ingot, 1), Character.valueOf('Y'),
                    new ItemStack(DCsAppleMilk.processor, 1), Character.valueOf('X'),
                    new ItemStack(Items.diamond_sword, 1) }));
        ...
        RegistryHelper.addRecipe(
            new ShapedRecipe(
                new ItemStack(DCsAppleMilk.rotaryDial, 1, 0),
                new Object[] { "XXX", "ZYZ", "XXX", Character.valueOf('X'),
                    new ItemStack(Blocks.stained_hardened_clay, 1, 15), Character.valueOf('Y'),
        ...
        RegistryHelper.addRecipe(
            new ShapedRecipe(
                ...
                new Object[] { "XYX", "WZW", "XVX", Character.valueOf('X'), new ItemStack(Items.iron_ingot, 1, 0),
                    Character.valueOf('Y'), new ItemStack(Items.redstone, 1, 0), Character.valueOf('Z'),
        ...
        RegistryHelper.addRecipe(
            new ShapedRecipe(
                ...
                new Object[] { " X ", " Y ", "XZX", Character.valueOf('X'), "ingotIron", Character.valueOf('Y'),
                    "gearChalcedony", Character.valueOf('Z'), new ItemStack(DCsAppleMilk.redGel, 1, 0) }));
        ...
        RegistryHelper.addRecipe(
            new ShapedRecipe(
                ...
                new Object[] { "  X", "YXZ", "WV ", Character.valueOf('X'), "blockChalcedony", Character.valueOf('Y'),
                    "gearIron", Character.valueOf('V'), new ItemStack(DCsAppleMilk.gelBat, 1, 0),
        ...
        RegistryHelper.addRecipe(
            new ShapedRecipe(
                ...
                new Object[] { " X ", "XYX", "ZZZ", Character.valueOf('X'),
                    new ItemStack(DCsAppleMilk.chalcedony, 1, 0), Character.valueOf('Y'),
                    new ItemStack(DCsAppleMilk.princessClam, 1, 0), Character.valueOf('Z'),
                    new ItemStack(Items.iron_ingot, 1, 0) }));
    ...
    /*
     * 縺薙・驛ｨ蛻・・縲∬､・焚縺ｮMod縺ｮ豌ｴ蜈･繧雁ｮｹ蝎ｨ繧貞叙蠕励＠縺溷ｾ後↓蜻ｼ縺ｳ蜃ｺ縺吶◆繧√｝ostInit縺ｫ蜻ｼ縺ｶ
     * 豌ｴ蜈･繧雁ｮｹ蝎ｨ縺ｮ蜿門ｾ励・LoadModHandler繧貞茜逕ｨ
     */
    public void addInstantTea() {
        ...
        if (LoadModHandler.getArray("containerWater") != null && !LoadModHandler.getArray("containerWater")
            .isEmpty()) {
    ...
    public void addCocktailSPRecipe() {
        ...
        for (int i = 0; i < string1.length; i++) {
            ...
            if (str.contains(":")) {
                ...
                // OreDitionary縺ｨ莠域Φ縺励※縲∵枚蟄怜・縺ｮ縺ｾ縺ｾ蜉縺医ｋ
                rec1[i] = str;
            }
        }
        ...
        RegistryHelper.addRecipe(new ShapelessRecipe(new ItemStack(DCsAppleMilk.cocktailSP, 1, 0), rec1));

        RegistryHelper.addRecipe(new ShapelessRecipe(new ItemStack(DCsAppleMilk.cocktailSP, 1, 1), rec2));

        RegistryHelper.addRecipe(new ShapelessRecipe(new ItemStack(DCsAppleMilk.cocktailSP, 1, 2), rec3));
    }
    ...
    // 驥大ｱ槭リ繧ｲ繝・ヨ縺ｮ繝ｬ繧ｷ繝皮匳骭ｲ繧ゅ∽ｻ邦OD縺ｮ繧｢繧､繝・Β霑ｽ蜉縺檎ｵゅｏ繧却ostInit縺ｧ蜻ｼ縺ｶ
    public void addMetalRecipe() {
        ...
        ArrayList<ItemStack> ingotTin = TagHelper.getTagItems("ingotTin");
        if (ingotTin.size() > 0) {
        ...
        ArrayList<ItemStack> ingotCopper = TagHelper.getTagItems("ingotCopper");
        ...
        ArrayList<ItemStack> ingotSilver = TagHelper.getTagItems("ingotSilver");
        ...
        ArrayList<ItemStack> ingotSteel = TagHelper.getTagItems("ingotSteel");
        ...
        ArrayList<ItemStack> ingotLead = TagHelper.getTagItems("ingotLead");
        if (ingotLead.size() > 0) {
        ...
        ArrayList<ItemStack> ingotBronze = TagHelper.getTagItems("ingotBronze");
    ...
    public static void addCardboardRecipe() {
        ArrayList<ItemStack> coffee = new ArrayList<ItemStack>(TagHelper.getTagItems("cropCoffee"));
        if (!coffee.isEmpty()) {
        ...
        ArrayList<ItemStack> bamboo = new ArrayList<ItemStack>(TagHelper.getTagItems("bamboo"));
        if (!bamboo.isEmpty()) {
        ...
        ArrayList<ItemStack> tomato = new ArrayList<ItemStack>(TagHelper.getTagItems("cropTomato"));
        tomato.addAll(TagHelper.getTagItems("tomato"));
        if (!tomato.isEmpty()) {
        ...
        ArrayList<ItemStack> grape = new ArrayList<ItemStack>(TagHelper.getTagItems("cropGrape"));
        grape.addAll(TagHelper.getTagItems("grape"));
        if (!grape.isEmpty()) {
