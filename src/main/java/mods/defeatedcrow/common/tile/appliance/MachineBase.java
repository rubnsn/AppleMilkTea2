...
public abstract class MachineBase extends TileEntity
    implements ISidedInventory, IChargeableMachine, IEnergyHandler, IEnergyInfo {
    ...
    public boolean isItemValidForSlot(int par1, ItemStack par2ItemStack) {
        return (par1 == 1 || par1 > 10) ? false
            : (par1 == 0 ? this.isItemFuel(par2ItemStack) : !this.isItemFuel(par2ItemStack));
    }
