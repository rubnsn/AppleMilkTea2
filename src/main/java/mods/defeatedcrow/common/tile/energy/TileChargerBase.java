                ...
                if (!flag && this.isItemFuel(this.itemstacks[0])) {
                    ...
                    if (i <= this.getMaxChargeAmount())// 指定したチャージ上限より小さいかどうか
                    {
                        if (this.itemstacks[0].getItem() instanceof IBattery) {
                            ...
                            // containerがある場合
                            if (this.itemstacks[1] == null || (this.itemstacks[1].getItem()
                                == this.batteryContainerItem(this.itemstacks[0])
                                    .getItem()
                                && this.itemstacks[1].getItemDamage() == this.batteryContainerItem(this.itemstacks[0])
                                    .getItemDamage()
