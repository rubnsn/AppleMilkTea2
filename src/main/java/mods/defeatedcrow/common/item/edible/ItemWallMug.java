        ...
        if (!par2World.isRemote) {
            if (type == 0)// Tea
            {
                if (par3EntityPlayer.isPotionActive(Potion.regeneration.id)) {
                    int d = par3EntityPlayer.getActivePotionEffect(Potion.regeneration)
                        .getDuration();
            ...
            } else if (type == 1)// Green Tea
            {
                if (par3EntityPlayer.isPotionActive(Potion.digSpeed.id)) {
                    int d = par3EntityPlayer.getActivePotionEffect(Potion.digSpeed)
                        .getDuration();
            ...
            } else if (type == 2)// Cocoa
            {
                if (par3EntityPlayer.isPotionActive(Potion.resistance.id)) {
                    int d = par3EntityPlayer.getActivePotionEffect(Potion.resistance)
                        .getDuration();
            ...
            } else if (type == 3)// Coffee
            {
                if (par3EntityPlayer.isPotionActive(Potion.damageBoost.id)) {
                    int d = par3EntityPlayer.getActivePotionEffect(Potion.damageBoost)
                        .getDuration();
