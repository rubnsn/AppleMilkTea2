...
public class ItemFossilCannon extends Item {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private mods.defeatedcrow.client.item.BEWLR_FossilCannon renderer;
            @Override
            public net.minecraft.client.renderer.BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null) {
                    renderer = new mods.defeatedcrow.client.item.BEWLR_FossilCannon(Minecraft.getInstance(), Minecraft.getInstance().getEntityModels());
                }
                return renderer;
            }
        });
