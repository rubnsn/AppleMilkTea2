        ...
        if (par2EntityPlayer.isSneaking()) {
            if (deco) {
                ...
                par3World.playSoundEffect(
                    ...
                    par5 + 0.5F,
                    par6 + 0.5F,
                    Blocks.stone.stepSound.getBreakSound(),
                    (Blocks.stone.stepSound.getVolume() + 1.0F) / 2.0F,
            ...
            if (brk) {
                ...
                if (i1 == Blocks.stone
                    ...
                    par3World.playSoundEffect(
                        ...
                        par5 + 0.5F,
                        par6 + 0.5F,
                        i1.stepSound.getBreakSound(),
                        (i1.stepSound.getVolume() + 1.0F) / 2.0F,
                        i1.stepSound.getPitch() * 0.8F);
