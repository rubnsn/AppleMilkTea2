...
public class RegisterMakerRecipe {
    ...
    public void registerTea() {
        ...
        RecipeRegisterManager.teaRecipe.registerCanMilk(
            ...
            new ItemStack(DCsAppleMilk.teacupBlock, 1, 4),
        ...
        RecipeRegisterManager.teaRecipe.registerCanMilk(
            ...
            new ItemStack(DCsAppleMilk.teacupBlock, 1, 2),
        ...
        RecipeRegisterManager.teaRecipe.registerCanMilk(
            ...
            new ItemStack(DCsAppleMilk.teaCup2, 1, 6),
    ...
    public void registerIce() {
        RecipeRegisterManager.iceRecipe
            .register(new ItemStack(DCsAppleMilk.condensedMIlk, 1, 0), new ItemStack(DCsAppleMilk.blockIcecream, 1, 0));
        ...
        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teacupBlock, 1, 5),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 2),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teacupBlock, 1, 7),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 3),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teacupBlock, 1, 9),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 5),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teacupBlock, 1, 11),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 6),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teacupBlock, 1, 13),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 4),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));
        ...
        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teaCup2, 1, 4),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 7),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teaCup2, 1, 5),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 8),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teaCup2, 1, 7),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 9),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teaCup2, 1, 8),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 10),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teaCup2, 1, 9),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 11),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teaCup2, 1, 11),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 12),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.teaCup2, 1, 12),
            new ItemStack(DCsAppleMilk.blockIcecream, 1, 13),
            new ItemStack(DCsAppleMilk.emptyCup, 1, 0));

        RecipeRegisterManager.iceRecipe.registerCanLeave(
            new ItemStack(DCsAppleMilk.itemLargeBottle, 1, 1),
            new ItemStack(DCsAppleMilk.cocktail, 1, 1),
    ...
    public void registerProcessor() {
        ...
        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.EXItems, 2, 6), true, null, new Object[] { DCsAppleMilk.clam });
        ...
        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 1), true, null, new Object[] { "cropPeach" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 1), true, null, new Object[] { "cropBanana" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 9), true, null, new Object[] { "cropOrange" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 1), true, null, new Object[] { "cropPlum" });
        ...
        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 3), true, null, new Object[] { "cropCoffee" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 5), true, null, new Object[] { "cropLime" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 5), true, null, new Object[] { "cropCitron" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 6), true, null, new Object[] { "cropTomato" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 6), true, null, new Object[] { "tomato" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 7), true, null, new Object[] { "cropStrawberry" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 7), true, null, new Object[] { "cropBlueberry" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 7), true, null, new Object[] { "cropRaspberry" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 7), true, null, new Object[] { "cropBlackberry" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 7), true, null, new Object[] { "cropCassis" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 8), true, null, new Object[] { "cropGrape" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.gratedApple, 1, 8), true, null, new Object[] { "grape" });
        ...
        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.mincedFoods, 1, 3), true, null, new Object[] { "cropRice" });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.mincedFoods, 1, 3), true, null, new Object[] { "cropWheat" });
        ...
        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(Items.clay_ball), false, 0, null, new Object[] { new ItemStack(Blocks.sand) });
        ...
        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(Items.clay_ball), false, 0, null, new Object[] { new ItemStack(Blocks.dirt) });
        ...
        RecipeRegisterManager.processorRecipe.addRecipe(
            ...
            0,
            null,
            new Object[] { "dustAsh", "dustOilCake", new ItemStack(DCsAppleMilk.EXItems, 1, 6),
                new ItemStack(Blocks.sand) });

        RecipeRegisterManager.processorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.dustWood, 1, 0), false, 0, null, new Object[] { "logWood" });
        ...
        RecipeRegisterManager.processorRecipe.addRecipe(
            new ItemStack(DCsAppleMilk.EXItems, 16, 7),
            false,
            null,
        ...
        RecipeRegisterManager.processorRecipe.addRecipe(
            new ItemStack(DCsAppleMilk.EXItems, 8, 7),
            false,
            null,
    ...
    public void registerEvaporator() {
        ...
        RecipeRegisterManager.evaporatorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.essentialOil, 1, 1), null, new ItemStack(Blocks.double_plant, 8, 4));

        RecipeRegisterManager.evaporatorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.essentialOil, 1, 2), null, new ItemStack(DCsAppleMilk.leafTea, 8, 1));

        RecipeRegisterManager.evaporatorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.essentialOil, 1, 3), null, new ItemStack(DCsAppleMilk.leafTea, 8, 3));

        RecipeRegisterManager.evaporatorRecipe
            .addRecipe(new ItemStack(DCsAppleMilk.essentialOil, 1, 4), null, new ItemStack(DCsAppleMilk.clam, 8, 0));

        RecipeRegisterManager.evaporatorRecipe.addRecipe(
            new ItemStack(DCsAppleMilk.essentialOil, 1, 5),
            null,
        ...
        RecipeRegisterManager.evaporatorRecipe.addRecipe(
            null,
            new FluidStack(DCsAppleMilk.rum_young, 100),
            new ItemStack(DCsAppleMilk.moromi, 1, 3),
            true);

        RecipeRegisterManager.evaporatorRecipe.addRecipe(
            null,
            new FluidStack(DCsAppleMilk.vodka_young, 100),
        ...
        RecipeRegisterManager.evaporatorRecipe.addRecipe(
            ...
            new ItemStack(DCsAppleMilk.leafTea, 8, 4));
        ...
        RecipeRegisterManager.evaporatorRecipe.addRecipe(
            new ItemStack(DCsAppleMilk.dustWood, 1, 3),
            new FluidStack(DCsAppleMilk.vegitableOil, 20),
    ...
    public void addKelpRecipe() {
        ...
        if (LoadModHandler.getArray("seaWeed") != null && !LoadModHandler.getArray("seaWeed")
            .isEmpty()) {
    ...
    public static void registerPlate() {
        ...
        RecipeRegisterManager.plateRecipe
            .register(new ItemStack(Items.beef), new ItemStack(DCsAppleMilk.foodPlate, 1, 0), 100, false);

        RecipeRegisterManager.plateRecipe
            .register(new ItemStack(Items.porkchop), new ItemStack(DCsAppleMilk.foodPlate, 1, 1), 100, false);

        RecipeRegisterManager.plateRecipe
            .register(new ItemStack(Items.chicken), new ItemStack(DCsAppleMilk.foodPlate, 1, 2), 100, true);

        RecipeRegisterManager.plateRecipe
            .register(new ItemStack(DCsAppleMilk.clam, 1, 0), new ItemStack(DCsAppleMilk.foodPlate, 1, 3), 40, false);

        RecipeRegisterManager.plateRecipe
            .register(new ItemStack(Items.fish, 1, 0), new ItemStack(Items.cooked_fished), 40, false);

        RecipeRegisterManager.plateRecipe
            .register(new ItemStack(Items.rotten_flesh, 1, 0), new ItemStack(Items.leather), 40, false);

        RecipeRegisterManager.plateRecipe
            .register(new ItemStack(DCsAppleMilk.EXItems, 1, 1), new ItemStack(Items.slime_ball), 40, true);
    }
    ...
    public static void registerChocolate() {
        ...
        RecipeRegisterManager.chocoRecipe
            .register(new ItemStack(Items.bread), new ItemStack(DCsAppleMilk.chocolateFruits, 1, 8));
        RecipeRegisterManager.chocoRecipe
            .register(new ItemStack(Items.cookie), new ItemStack(DCsAppleMilk.chocolateFruits, 1, 9));
        RecipeRegisterManager.chocoRecipe.register(
            new ItemStack(DCsAppleMilk.gratedApple, 1, 4),
            new ItemStack(DCsAppleMilk.chocolateFruits, 1, 10));
        RecipeRegisterManager.chocoRecipe
            .register(new ItemStack(DCsAppleMilk.toffyApple), new ItemStack(DCsAppleMilk.chocolateFruits, 1, 12));
        RecipeRegisterManager.chocoRecipe
            .register(new ItemStack(DCsAppleMilk.EXItems, 1, 0), new ItemStack(DCsAppleMilk.chocolateFruits, 1, 11));
    ...
    public static void registerSoupSource() {
        ...
        RecipeRegisterManager.fondueRecipe
            .registerSource(new ItemStack(DCsAppleMilk.bottleCamOil, 1, 0), SoupType.EMPTY, SoupType.OIL);
        RecipeRegisterManager.fondueRecipe
            .registerSource(new ItemStack(DCsAppleMilk.bottleVegiOil, 1, 0), SoupType.EMPTY, SoupType.OIL);
        ...
        RecipeRegisterManager.fondueRecipe
            .register(new ItemStack(Items.bowl, 1, 0), new ItemStack(DCsAppleMilk.baseSoupBowl, 1, 0), SoupType.WATER);
        RecipeRegisterManager.fondueRecipe
            .register(new ItemStack(Items.bowl, 1, 0), new ItemStack(DCsAppleMilk.baseSoupBowl, 1, 1), SoupType.CHOCO);
        RecipeRegisterManager.fondueRecipe
            .register(new ItemStack(Items.bowl, 1, 0), new ItemStack(DCsAppleMilk.baseSoupBowl, 1, 2), SoupType.OIL);
        RecipeRegisterManager.fondueRecipe
            .register(new ItemStack(Items.bowl, 1, 0), new ItemStack(DCsAppleMilk.baseSoupBowl, 1, 8), SoupType.CHEESE);
    }
