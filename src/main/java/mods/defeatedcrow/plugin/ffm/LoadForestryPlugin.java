...
public class LoadForestryPlugin {
    ...
    public static void load() {
            ...
            if (register != null) {
                ...
                GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                        ...
                        new Object[] { "XXX", "XYX", "XXX", Character.valueOf('Y'), new ItemStack(Items.bread, 1, 0),
            ...
            if (register != null) {
                ...
                GameRegistry.addRecipe(
                    new ShapelessOreRecipe(
                        ...
                        new Object[] { "dustOilCake", new ItemStack(Items.dye, 1, 15), "dustAsh" }));

                GameRegistry.addRecipe(
                    new ShapelessOreRecipe(
                        new ItemStack(register.getItem(), 2, register.getItemDamage()),
                        new Object[] { "dustOilCake", "dustClam", "dustAsh" }));
                ...
                if (mulch != null) {
                    ...
                    GameRegistry.addRecipe(
                        new ShapelessOreRecipe(
                            new ItemStack(register.getItem(), 2, register.getItemDamage()),
                            new Object[] { mulch, new ItemStack(Items.dye, 1, 15), "dustAsh" }));

                    GameRegistry.addRecipe(
                        new ShapelessOreRecipe(
                            new ItemStack(register.getItem(), 2, register.getItemDamage()),
                            new Object[] { mulch, "dustClam", "dustAsh" }));
                }
        ...
        if (FluidRegistry.isFluidRegistered("vegitable_oil")) {
            FuelManager.bronzeEngineFuel
                .put(DCsAppleMilk.vegitableOil, new EngineBronzeFuel(DCsAppleMilk.vegitableOil, 2, 2500, 1));
        ...
        if (FluidRegistry.isFluidRegistered("camellia_oil")) {
            FuelManager.bronzeEngineFuel
                .put(DCsAppleMilk.camelliaOil, new EngineBronzeFuel(DCsAppleMilk.camelliaOil, 4, 2500, 1));
    ...
    public static void loadRecipes(boolean flag) {
        ...
        RecipeManagers.squeezerManager.addRecipe(
            4,
            new ItemStack[] { new ItemStack(DCsAppleMilk.leafTea, 8, 4) },
        ...
        if (juice != null && biomass != null && ice != null) {
            RecipeManagers.squeezerManager.addRecipe(
                4,
                new ItemStack[] { new ItemStack(DCsAppleMilk.leafTea, 4, 1) },
                new FluidStack(juice, 100),
                new ItemStack(DCsAppleMilk.essentialOil, 1, 2),
                3);

            RecipeManagers.squeezerManager.addRecipe(
                4,
                new ItemStack[] { new ItemStack(DCsAppleMilk.leafTea, 4, 3) },
                new FluidStack(juice, 200),
                new ItemStack(DCsAppleMilk.essentialOil, 1, 3),
                3);

            RecipeManagers.squeezerManager.addRecipe(
                4,
                new ItemStack[] { new ItemStack(DCsAppleMilk.clam, 4, 0) },
                new FluidStack(biomass, 100),
                new ItemStack(DCsAppleMilk.essentialOil, 1, 4),
                3);

            RecipeManagers.squeezerManager.addRecipe(
                4,
                new ItemStack[] { new ItemStack(DCsAppleMilk.icyCrystal, 1, 0) },
                new FluidStack(ice, 1000),
            ...
            if (glass != null) {
                RecipeManagers.fabricatorManager.addRecipe(
                    null,
                    new FluidStack(glass, 500),
                    new ItemStack(chalCircuit, 1, 0),
                    new Object[] { " X ", "YXY", "XXX", 'X', DCsAppleMilk.chalcedony, 'Y', Items.redstone });
            }
    ...
    public static void registerFarming() {
        ...
        farmables = new IFarmable[] { new FarmableAMT(DCsAppleMilk.teaTree, 1),
            new FarmableAMT(DCsAppleMilk.cassisTree, 3), new FarmableAMT(DCsAppleMilk.cassisTree, 7) };
