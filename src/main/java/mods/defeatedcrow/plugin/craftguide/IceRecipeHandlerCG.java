...
public class IceRecipeHandlerCG implements RecipeProvider {
    ...
    public void generateRecipes(RecipeGenerator generator) {
        ...
        template = generator
            .createRecipeTemplate(this.slots, iceMaker, "defeatedcrow:textures/gui/craftguidegui.png", 1, 60, 82, 60);
        HashMap<ItemStack, ItemStack[]> recipeGet = RegisteredRecipeGet.iceRecipeList;
        Iterator<Entry<ItemStack, ItemStack[]>> inputs = recipeGet.entrySet()
            .iterator();
