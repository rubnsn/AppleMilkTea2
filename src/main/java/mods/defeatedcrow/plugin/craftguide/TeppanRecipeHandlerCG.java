...
public class TeppanRecipeHandlerCG implements RecipeProvider {
    ...
    public void generateRecipes(RecipeGenerator generator) {
        ...
        template = generator
            .createRecipeTemplate(this.slots, machine, "defeatedcrow:textures/gui/craftguidegui.png", 1, 1, 82, 1);
        ...
        for (PlateRecipe recipe : recipeGet) {
            ...
            ItemStack mode = recipe.useOvenRecipe() ? new ItemStack(DCsAppleMilk.dummyTeppan, 1, 0)
                : new ItemStack(DCsAppleMilk.dummyTeppan, 1, 1);
