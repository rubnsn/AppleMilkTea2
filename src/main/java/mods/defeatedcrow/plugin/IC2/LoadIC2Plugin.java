...
public class LoadIC2Plugin {
    ...
    public void load() {
        ...
        this.IC2Cell = new ItemStack(
            IC2Items.getItem("cell")
                .getItem(),
            1,
            IC2Items.getItem("cell")
                .getItemDamage());
        this.IC2WaterCell = new ItemStack(
            IC2Items.getItem("waterCell")
                .getItem(),
            1,
            IC2Items.getItem("waterCell")
                .getItemDamage());
        this.IC2CoffeeBeans = new ItemStack(
            IC2Items.getItem("coffeeBeans")
                .getItem(),
            1,
            IC2Items.getItem("coffeeBeans")
                .getItemDamage());
        this.IC2Coffeepowder = new ItemStack(
            IC2Items.getItem("coffeePowder")
                .getItem(),
            1,
            IC2Items.getItem("coffeePowder")
                .getItemDamage());
        this.IC2Mug = new ItemStack(
            IC2Items.getItem("mugEmpty")
                .getItem(),
            1,
            0);
        this.IC2MugCoffee = new ItemStack(
            IC2Items.getItem("mugCoffee")
                .getItem(),
            1,
            1);
        this.IC2MugCoffeeMilk = new ItemStack(
            IC2Items.getItem("mugCoffee")
                .getItem(),
            1,
            2);
        this.IC2dropRubber = new ItemStack(
            IC2Items.getItem("rubber")
                .getItem(),
            1,
            IC2Items.getItem("rubber")
                .getItemDamage());
        this.IC2Furnace = new ItemStack(
