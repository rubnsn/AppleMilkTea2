...
public class RegisterSellItem {
    ...
    public static void registerSellable() {
        ...
        for (int i = 0; i < 11; i++) {
            if (i < 8) MCEconomyAPI.addPurchaseItem(new ItemStack(DCsAppleMilk.princessClam, 1, i), 50);
            else MCEconomyAPI.addPurchaseItem(new ItemStack(DCsAppleMilk.princessClam, 1, i), 150);
        }
