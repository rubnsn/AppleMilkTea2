...
public class LoadBambooPlugin {
    ...
    public void loadBambooItems() {
        try {
            ...
            Object obj = Class.forName("ruby.bamboo.BambooInit")
                .getField("rawrice")
                .get(null);
                ...
                if (registerItem4 != null) {
                    GameRegistry.addRecipe(
                        new ShapedOreRecipe(
                            ...
                            new Object[] { "XXX", "XXX", "XXX", Character.valueOf('X'), registerItem4 }));
    ...
    public static void loadBambooRecipes(boolean flag) // BambooMod様の石臼、囲炉裏にレシピを追加
    {
        ...
        try {
            ...
            CookingRegistory.addShapelessRecipe(
                new ItemStack(DCsAppleMilk.appleSandwich, 3, 0),
                new ItemStack(Items.apple),
                "foodDough");

            CookingRegistory.addShapelessRecipe(
                new ItemStack(DCsAppleMilk.appleSandwich, 3, 1),
                new ItemStack(Items.egg),
                "foodDough");

            CookingRegistory.addShapelessRecipe(
                new ItemStack(DCsAppleMilk.appleTart, 2, 0),
                new ItemStack(Items.apple),
                "foodDough",
                "foodSugar");

            CookingRegistory.addShapelessRecipe(
                new ItemStack(DCsAppleMilk.appleTart, 2, 2),
                "cropYuzu",
                "bucketMilk",
                "foodSugar",
                new ItemStack(Items.egg));
            ...
            CookingRegistory.addShapelessRecipe(
                new ItemStack(DCsAppleMilk.appleTart, 2, 3),
                "cropApricot",
                "bucketMilk",
                "foodSugar",
                new ItemStack(Items.egg));
            ...
            CookingRegistory.addShapelessRecipe(
                new ItemStack(DCsAppleMilk.appleSandwich, 3, 2),
                "foodSugar",
                "foodDough",
                new ItemStack(DCsAppleMilk.leafTea, 1, 2));

            CookingRegistory.addShapelessRecipe(
                new ItemStack(DCsAppleMilk.appleSandwich, 3, 3),
                "foodSugar",
                "foodDough",
