...
public class LoadModHandler {
            ...
            if (item3 != null) {
                ...
                GameRegistry.addRecipe(
                    new ShapelessOreRecipe(
                        ...
                        new Object[] { "bottleRum", new ItemStack(item3, 1), "cropCoconut", "foodCrushedIce" }));

                GameRegistry.addRecipe(
                    new ShapelessOreRecipe(
                        new ItemStack(DCsAppleMilk.cocktail, 1, 6),
                        new Object[] { "bottleRum", new ItemStack(item3, 1), new ItemStack(Items.milk_bucket, 1),
                            "foodCrushedIce" }));
            }
        } catch (Exception e) {
            AMTLogger.debugInfo("Failed to register ModItems");
    ...
    public void loadMaple() { // モミジMOD様のアイテム。
        ...
        try {
            ...
            if (block != null) {
                ...
                GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                        ...
                        new Object[] { "XXX", "XXX", "XXX", Character.valueOf('X'), registerItem2 }));

                GameRegistry.addRecipe(
                    new ShapelessOreRecipe(
                        new ItemStack(block, 9, 0),
                        new Object[] { new ItemStack(DCsAppleMilk.woodBox, 1, 9) }));
            }
            ...
            if (rape.size() > 0) {
                ItemStack rapeseed = new ItemStack(
                    rape.get(0)
                        .getItem(),
                    1,
                    rape.get(0)
            ...
            if (vanilla != null) {
                ...
                if (va != null) {
                    ...
                    RecipeRegisterManager.evaporatorRecipe.addRecipe(
                        new ItemStack(DCsAppleMilk.essentialOil, 1, 7),
                        null,
                        new ItemStack(va.getItem(), 8, 0));
                }
            }
    ...
    public void loadExtraTrees() { // ExtraTree様のアイテム。
        ...
        try {
            Object obj = Class.forName("binnie.extratrees.ExtraTrees")
                .getField("itemFood")
                .get(null);
                ...
                if (this.registerModItems("hagane", hagane)) {
                    ...
                    GameRegistry.addRecipe(
                        new ShapedOreRecipe(
                            ...
                            new Object[] { " X ", "XYX", " X ", Character.valueOf('Y'),
                                new ItemStack(DCsAppleMilk.cLamp, 1, 3), Character.valueOf('X'), hagane }));
                }
            }
        } catch (Exception e) {
            AMTLogger.debugInfo("Failed to register ModItems");
