...
public class ModelBarrelBase {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("base1", CubeListBuilder.create().texOffs(0, 0).addBox(-6F, 8.1F, 6F, 12, 1, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("base2", CubeListBuilder.create().texOffs(0, 0).addBox(-6F, 8.1F, -7F, 12, 1, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("base3", CubeListBuilder.create().texOffs(0, 0).addBox(-6F, 6F, 6F, 12, 1, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("base4", CubeListBuilder.create().texOffs(0, 0).addBox(-6F, 6F, -7F, 12, 1, 1), PartPose.offset(0F, 16F, 0F));
        ...
        root.addOrReplaceChild("base13", CubeListBuilder.create().texOffs(0, 8).addBox(-7F, 5F, 4.5F, 14, 1, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("base14", CubeListBuilder.create().texOffs(0, 8).addBox(-7F, 5F, -5.5F, 14, 1, 1), PartPose.offset(0F, 16F, 0F));
