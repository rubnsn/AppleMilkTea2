...
public class ModelCocktail extends ModelBase {
    ...
    public void renderInnerSP(Entity entity, float f, float f1, float f2, float f3, float f4, float f5,
        ModelType type) {
        super.render(entity, f, f1, f2, f3, f4, f5);
        setRotationAngles(f, f1, f2, f3, f4, f5, entity);
    ...
    public void renderGlassSP(Entity entity, float f, float f1, float f2, float f3, float f4, float f5,
        ModelType type) {
        super.render(entity, f, f1, f2, f3, f4, f5);
        setRotationAngles(f, f1, f2, f3, f4, f5, entity);
