...
public class ModelAltDial {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("tou3", CubeListBuilder.create().texOffs(14, 19).addBox(-4F, -1.8F, -0.5F, 3, 1, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("juwa1", CubeListBuilder.create().texOffs(25, 0).addBox(-0.5F, -3F, -4.5F, 1, 1, 2), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("juwa2", CubeListBuilder.create().texOffs(33, 0).addBox(-2F, -5F, -6F, 4, 4, 2), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("juwa3", CubeListBuilder.create().texOffs(46, 0).addBox(-1.5F, -8F, 3F, 3, 3, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("juwa4", CubeListBuilder.create().texOffs(46, 0).addBox(-1.5F, -9.5F, 1.5F, 3, 3, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("juwa5", CubeListBuilder.create().texOffs(46, 0).addBox(-0.5F, -8.7F, 1.5F, 1, 3, 3), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("juwa6", CubeListBuilder.create().texOffs(46, 0).addBox(-0.5F, -8.7F, 1.5F, 1, 3, 3), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("dial1", CubeListBuilder.create().texOffs(33, 7).addBox(-3F, 3F, 1.5F, 6, 6, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("dial2", CubeListBuilder.create().texOffs(48, 7).addBox(-3F, 3F, 1.4F, 6, 6, 0), PartPose.offset(0F, 16F, 0F));
