...
public class ModelCupHandle {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("handleb1", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 2, 1, 2), PartPose.offset(-1F, 17F, 3F));
        root.addOrReplaceChild("handleb3", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 2, 1, 2), PartPose.offset(-1F, 22F, 3F));
        root.addOrReplaceChild("handleb2", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 2, 6, 1), PartPose.offset(-1F, 17F, 5F));
        root.addOrReplaceChild("handlec1", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 2, 1, 2), PartPose.offset(3F, 17F, -1F));
        root.addOrReplaceChild("handlec3", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 2, 1, 2), PartPose.offset(3F, 22F, -1F));
        root.addOrReplaceChild("handlec2", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 1, 6, 2), PartPose.offset(5F, 17F, -1F));
        root.addOrReplaceChild("handled1", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 2, 1, 2), PartPose.offset(-5F, 17F, -1F));
        root.addOrReplaceChild("handled3", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 2, 1, 2), PartPose.offset(-5F, 22F, -1F));
        root.addOrReplaceChild("handled2", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 1, 6, 2), PartPose.offset(-6F, 17F, -1F));
        root.addOrReplaceChild("sideF", CubeListBuilder.create().texOffs(0, 10).addBox(-3F, 0F, -3F, 6, 8, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("sideB", CubeListBuilder.create().texOffs(0, 10).addBox(-3F, 0F, 2F, 6, 8, 1), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("sideR", CubeListBuilder.create().texOffs(15, 10).addBox(-3F, 0F, -2F, 1, 8, 4), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("sideL", CubeListBuilder.create().texOffs(15, 10).addBox(2F, 0F, -2F, 1, 8, 4), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("Bottom", CubeListBuilder.create().texOffs(0, 0).addBox(-2F, 0F, -2F, 4, 2, 4), PartPose.offset(0F, 22F, 0F));
