...
public class ModelBreadAlt {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("bread1", CubeListBuilder.create().texOffs(0, 0).addBox(-1F, -10F, 1.5F, 4, 16, 3), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("bread2", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -10F, 1.5F, 4, 16, 3), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("bread3", CubeListBuilder.create().texOffs(16, 0).addBox(-2F, -8F, -2F, 3, 14, 3), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("bread4", CubeListBuilder.create().texOffs(16, 0).addBox(0F, -8F, 1.5F, 3, 14, 3), PartPose.offset(0F, 16F, 0F));
        root.addOrReplaceChild("bread5", CubeListBuilder.create().texOffs(16, 0).addBox(-0.5F, -7F, -5F, 3, 14, 3), PartPose.offset(0F, 16F, 0F));
