...
public class ModelWipeBox2 {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("paperbox", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-6F, 0F, -7.5F, 12, 9, 15), PartPose.offset(0F, 15F, 0F));
    ...
    public void renderToBuffer(com.mojang.blaze3d.vertex.PoseStack pose, com.mojang.blaze3d.vertex.VertexConsumer buf, int light, int overlay, float r, float g, float b, float a) {
        paperbox.render(pose, buf, light, overlay, r, g, b, a);
    }
}
