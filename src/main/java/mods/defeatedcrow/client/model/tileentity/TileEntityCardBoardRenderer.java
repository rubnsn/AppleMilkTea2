...
import mods.defeatedcrow.client.model.model.ModelAltCatoraryBox;
...
public class TileEntityCardBoardRenderer implements BlockEntityRenderer<TileCardBoard> {
    ...
    public TileEntityCardBoardRenderer(BlockEntityRendererProvider.Context ctx) {
        ...
        this.model = new ModelAltCatoraryBox(ModelAltCatoraryBox.createBodyLayer().bakeRoot());
    }

    @Override
    public void render(TileCardBoard be, float partialTicks, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
        pose.pushPose();
