 ...
 *
 * <p>Original geometry: {@link mods.defeatedcrow.client.model.model.ModelWipeBox}
 * (ModelBase-based, owned by client/model/model - not yet converted to LayerDefinition/ModelPart).</p>
 */
public class TileEntityWipeBoxRenderer implements BlockEntityRenderer<TileWipeBox> {

    private static final ResourceLocation WIPE_TEX = new ResourceLocation(
        "defeatedcrow:textures/entity/wipebox.png");


    private final BlockEntityRendererProvider.Context context;

    public TileEntityWipeBoxRenderer(BlockEntityRendererProvider.Context context) {
        this.context = context;
    }

    @Override
    public void render(TileWipeBox tile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource,
        ...
        // TODO: restore ModelWipeBox rendering via
