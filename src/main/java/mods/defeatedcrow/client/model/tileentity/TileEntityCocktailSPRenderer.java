 ...
 */
public class TileEntityCocktailSPRenderer implements BlockEntityRenderer<TileCocktailSP> {

    private static final ResourceLocation COCKTAIL_TEX = new ResourceLocation(
        "defeatedcrow:textures/entity/cocktail.png");
    private static final ResourceLocation INNER_TEX = new ResourceLocation(
        "defeatedcrow:textures/blocks/contents_cocktailbase.png");


    private final BlockEntityRendererProvider.Context context;

    public TileEntityCocktailSPRenderer(BlockEntityRendererProvider.Context context) {
        this.context = context;
    }

    @Override
    public void render(TileCocktailSP tile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource,
            int packedLight, int packedOverlay) {
        // Original also drew an inner contents quad with an innerTexPass-built texture.
