 ...
 *
 * <p>Original geometry: {@link mods.defeatedcrow.client.model.model.ModelHandleEngine}
...
public class TileEntityEHandleRenderer implements BlockEntityRenderer<TileHandleEngine> {
    ...
    private static final ResourceLocation HANDLE_TEX = new ResourceLocation(
        "defeatedcrow:textures/entity/handle_engine.png");


    private final BlockEntityRendererProvider.Context context;

    public TileEntityEHandleRenderer(BlockEntityRendererProvider.Context context) {
        this.context = context;
    }

    @Override
    public void render(TileHandleEngine tile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource,
            int packedLight, int packedOverlay) {
        // Original rendered both model.render(...) and model.renderBase(...); rotation from getBlockMetadata().
        ...
        // TODO: restore ModelHandleEngine rendering via
