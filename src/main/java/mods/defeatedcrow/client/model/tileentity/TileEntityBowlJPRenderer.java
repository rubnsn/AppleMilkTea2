...
public class TileEntityBowlJPRenderer implements BlockEntityRenderer<TileJPBowl> {
    ...
    public TileEntityBowlJPRenderer(BlockEntityRendererProvider.Context ctx) {
        ...
        this.model = new ModelBowlJP(ModelBowlJP.createBodyLayer().bakeRoot());
    }

    @Override
    public void render(TileJPBowl be, float partialTicks, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
        pose.pushPose();
