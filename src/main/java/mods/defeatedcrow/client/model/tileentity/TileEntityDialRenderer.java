...
public class TileEntityDialRenderer implements BlockEntityRenderer<TileRotaryDial> {
    ...
    public TileEntityDialRenderer(BlockEntityRendererProvider.Context ctx) {
        ...
        this.model = new ModelRotaryDial(ModelRotaryDial.createBodyLayer().bakeRoot());
    }

    @Override
    public void render(TileRotaryDial be, float partialTicks, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
        pose.pushPose();
