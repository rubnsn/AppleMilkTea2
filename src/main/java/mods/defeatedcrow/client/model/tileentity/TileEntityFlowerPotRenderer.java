...
public class TileEntityFlowerPotRenderer implements BlockEntityRenderer<TileFlowerPot> {
    ...
    public TileEntityFlowerPotRenderer(BlockEntityRendererProvider.Context ctx) {
        ...
        this.model = new ModelFlowerPot(ModelFlowerPot.createBodyLayer().bakeRoot());
    }

    @Override
    public void render(TileFlowerPot be, float partialTicks, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
        pose.pushPose();
