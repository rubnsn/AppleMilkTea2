...
public class TileEntityCocktailRenderer implements BlockEntityRenderer<TileCocktail> {
    ...
    public TileEntityCocktailRenderer(BlockEntityRendererProvider.Context ctx) {
    ...
    @Override
    public void render(TileCocktail be, float partialTicks, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
        pose.pushPose();
