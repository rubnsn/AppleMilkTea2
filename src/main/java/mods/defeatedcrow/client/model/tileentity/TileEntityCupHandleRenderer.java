...
public class TileEntityCupHandleRenderer extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation SummerTex = new ResourceLocation(
    ...
    public void renderTileEntityCupAt(TileCupHandle par1TileCupHandle, double par2, double par4, double par6,
        float par8) {
