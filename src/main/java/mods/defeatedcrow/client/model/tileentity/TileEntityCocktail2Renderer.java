...
public class TileEntityCocktail2Renderer implements BlockEntityRenderer<TileCocktail2> {
    ...
    public TileEntityCocktail2Renderer(BlockEntityRendererProvider.Context context) {
        this.context = context;
    }

    @Override
    public void render(TileCocktail2 tile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource,
