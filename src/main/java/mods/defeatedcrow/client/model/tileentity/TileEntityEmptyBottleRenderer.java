...
public class TileEntityEmptyBottleRenderer implements BlockEntityRenderer<TileEmptyBottle> {
    ...
    private static final ResourceLocation BOTTLE_TEX = new ResourceLocation(
        "defeatedcrow:textures/entity/largebottle.png");


    private final BlockEntityRendererProvider.Context context;

    public TileEntityEmptyBottleRenderer(BlockEntityRendererProvider.Context context) {
        this.context = context;
    }

    @Override
    public void render(TileEmptyBottle tile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource,
            int packedLight, int packedOverlay) {
        // Original rebuilt bottleTex at runtime (texPass).
