 ...
 *
 * <p>Original geometry: {@link mods.defeatedcrow.client.model.model.ModelIceCream}
 * (ModelBase-based, owned by client/model/model - not yet converted to LayerDefinition/ModelPart).</p>
 */
public class TileEntityIceCreamRenderer implements BlockEntityRenderer<TileIceCream> {

    private static final ResourceLocation ICE_TEX = new ResourceLocation(
        "defeatedcrow:textures/entity/icecream.png");


    private final BlockEntityRendererProvider.Context context;

    public TileEntityIceCreamRenderer(BlockEntityRendererProvider.Context context) {
        this.context = context;
    }

    @Override
    public void render(TileIceCream tile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource,
            int packedLight, int packedOverlay) {
        // Original read getBlockMetadata() for flavour/yaw.
        ...
        // TODO: restore ModelIceCream rendering via
