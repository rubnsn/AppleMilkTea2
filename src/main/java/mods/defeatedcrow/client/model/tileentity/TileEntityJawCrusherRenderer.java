 ...
 *
 * <p>Original geometry: {@link mods.defeatedcrow.client.model.model.ModelJawCrusher}
...
public class TileEntityJawCrusherRenderer implements BlockEntityRenderer<TileAdvProcessor> {
    ...
    public TileEntityJawCrusherRenderer(BlockEntityRendererProvider.Context context) {
        this.context = context;
    }

    @Override
    public void render(TileAdvProcessor tile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource,
            int packedLight, int packedOverlay) {
        // Original read getBlockMetadata() for facing.
        ...
        // TODO: restore ModelJawCrusher rendering via
