...
public class GuiProcessor extends AbstractContainerScreen<ContainerProcessor> {
    private static final ResourceLocation TEX = new ResourceLocation("defeatedcrow", "textures/gui/foodprocessorgui.png");
    public GuiProcessor(ContainerProcessor m, Inventory inv, Component c) { super(m, inv, c); this.imageWidth=176; this.imageHeight=166; }
    @Override protected void renderBg(GuiGraphics g, float f, int x, int y){
        ...
        int i2 = cook * 24 / 100;
        if(i2>24) i2=24;
        g.blit(TEX, k + 88, l + 35, 176, 0, i2 + 1, 16);
    }
