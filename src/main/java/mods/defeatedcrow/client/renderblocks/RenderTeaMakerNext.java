...
public class RenderTeaMakerNext implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (modelId == this.getRenderId()) {
            ...
            renderer.setOverrideBlockTexture(this.boxIIcon);
            block
                .setBlockBounds(4.0F / 16.0F, 13.0F / 16.0F, 4.0F / 16.0F, 12.0F / 16.0F, 16.0F / 16.0F, 12.0F / 16.0F);
            renderer.setRenderBoundsFromBlock(block);
            renderer.renderStandardBlock(block, x, y, z);
            ...
            if (meta == 0) {
                ...
                renderer.setOverrideBlockTexture(this.boxIIcon);
                block
                    .setBlockBounds(7.0F / 16.0F, 5.0F / 16.0F, 2.0F / 16.0F, 9.0F / 16.0F, 6.0F / 16.0F, 3.0F / 16.0F);
                renderer.setRenderBoundsFromBlock(block);
                renderer.renderStandardBlock(block, x, y, z);
                renderer.setOverrideBlockTexture(this.boxIIcon);
                block.setBlockBounds(
                ...
                renderer.setOverrideBlockTexture(this.boxIIcon);
                block
                    .setBlockBounds(2.0F / 16.0F, 5.0F / 16.0F, 7.0F / 16.0F, 3.0F / 16.0F, 6.0F / 16.0F, 9.0F / 16.0F);
                renderer.setRenderBoundsFromBlock(block);
                renderer.renderStandardBlock(block, x, y, z);
                renderer.setOverrideBlockTexture(this.boxIIcon);
                block.setBlockBounds(
