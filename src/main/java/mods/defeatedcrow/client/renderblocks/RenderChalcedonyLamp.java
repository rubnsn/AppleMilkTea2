    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (modelId == this.getRenderId()) {
            if (meta < 4) {
                ...
                block
                    .setBlockBounds(7.5F / 16.0F, 1.0F / 16.0F, 7.5F / 16.0F, 8.5F / 16.0F, 6.0F / 16.0F, 8.5F / 16.0F);
                renderer.setRenderBoundsFromBlock(block);
                renderer.renderStandardBlock(block, x, y, z);
                renderer.setOverrideBlockTexture(this.IIcon4);
                block.setBlockBounds(
                ...
                renderer.setOverrideBlockTexture(this.IIcon4);
                block
                    .setBlockBounds(7.5F / 16.0F, 1.0F / 16.0F, 7.5F / 16.0F, 8.5F / 16.0F, 7.0F / 16.0F, 8.5F / 16.0F);
                renderer.setRenderBoundsFromBlock(block);
                renderer.renderStandardBlock(block, x, y, z);
                renderer.setOverrideBlockTexture(this.IIcon4);
                block.setBlockBounds(
                ...
                renderer.setOverrideBlockTexture(this.IIcon4);
                block
                    .setBlockBounds(7.5F / 16.0F, 1.0F / 16.0F, 7.5F / 16.0F, 8.5F / 16.0F, 3.0F / 16.0F, 8.5F / 16.0F);
                renderer.setRenderBoundsFromBlock(block);
                renderer.renderStandardBlock(block, x, y, z);
                renderer.setOverrideBlockTexture(this.IIcon4);
                block.setBlockBounds(
