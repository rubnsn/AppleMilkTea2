...
public class RenderContainerWBottle implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (modelId == this.getRenderId()) {
            ...
            block
                .setBlockBounds(0.0F / 16.0F, 11.0F / 16.0F, 0.0F / 16.0F, 16.0F / 16.0F, 12.0F / 16.0F, 16.0F / 16.0F);
            renderer.setRenderBoundsFromBlock(block);
            renderer.renderStandardBlock(block, x, y, z);
            ...
            renderer.setOverrideBlockTexture(this.sideIcon);
            block
                .setBlockBounds(15.0F / 16.0F, 0.0F / 16.0F, 0.0F / 16.0F, 16.0F / 16.0F, 12.0F / 16.0F, 16.0F / 16.0F);
            renderer.setRenderBoundsFromBlock(block);
            renderer.renderStandardBlock(block, x, y, z);
            renderer.setOverrideBlockTexture(this.sideIcon);
            ...
            renderer.setOverrideBlockTexture(this.sideIcon);
            block
                .setBlockBounds(1.0F / 16.0F, 0.0F / 16.0F, 15.0F / 16.0F, 15.0F / 16.0F, 12.0F / 16.0F, 16.0F / 16.0F);
            renderer.setRenderBoundsFromBlock(block);
            renderer.renderStandardBlock(block, x, y, z);
