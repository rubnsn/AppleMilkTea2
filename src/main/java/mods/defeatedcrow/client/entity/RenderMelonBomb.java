...
public class RenderMelonBomb extends EntityRenderer<EntityMelonBomb> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("defeatedcrow", "textures/entity/compressedmelon.png");

    private final ModelMelonBomb modelMelonBomb;

    public RenderMelonBomb(EntityRendererProvider.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.5F;
        this.modelMelonBomb = new ModelMelonBomb(ctx.bakeLayer(ModEntityRenderers.MODEL_MELON_BOMB));
    }

    @Override
    public void render(EntityMelonBomb entity, float yaw, float partialTick, PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(EntityMelonBomb entity) {
        return TEXTURE;
    }
}
