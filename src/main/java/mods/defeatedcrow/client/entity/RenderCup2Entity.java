 ...
 */
public class RenderCup2Entity extends EntityRenderer<PlaceableCup2> {
    ...
    public RenderCup2Entity(EntityRendererProvider.Context ctx) {
        super(ctx);
    ...
    @Override
    public void render(PlaceableCup2 entity, float yaw, float partialTick, PoseStack poseStack,
        ...
        ResourceLocation innerTex = new ResourceLocation("defeatedcrow",
            "textures/blocks/contents" + BlockFilledCup2.contents[l] + ".png");
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(PlaceableCup2 entity) {
        return CUP_TEX;
    }
}
