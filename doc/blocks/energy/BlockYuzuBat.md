...
> Category: `energy`  
> Source: `src/main/java/mods/defeatedcrow/common/block/energy/BlockYuzuBat.java:1`  
> Registry: `defeatedcrow.yuzuBatContainer` (`DCsAppleMilk.yuzuBat`)  
...
## 登録情報
- **フィールド定義**: `DCsAppleMilk.java:168` `public static Block yuzuBat;`
- **インスタンス生成**: `MaterialRegister.java:1082` `new BlockYuzuBat()` / `setBlockName("defeatedcrow.yuzuBatContainer")`
- **GameRegistry**: `GameRegistry.registerBlock(DCsAppleMilk.yuzuBat, ItemBatBox.class, "defeatedcrow.yuzuBatContainer")` (`MaterialRegister.java:331`)
- **Material / Hardness / Resistance**: `Material.ground`, hardness `1.0F`, resistance `2.0F` (`BlockYuzuBat.java:1`)
...
## レンダー / モデル
- Render ID: `DCsAppleMilk.modelYuzuBat` (`DCsAppleMilk.java: - ` 初期化, `CommonProxy.getRenderID()` , `ClientProxy.registerRenderers()` で登録)
