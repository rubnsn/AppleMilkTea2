...
> Category: `energy`  
> Source: `src/main/java/mods/defeatedcrow/common/block/energy/BlockYuzuLight.java:1`  
> Registry: `defeatedcrow.lightGel` (`DCsAppleMilk.yuzuGel`)  
> ItemBlock: `なし`  
> TileEntity: `なし`  
...
## 登録情報
- **フィールド定義**: `DCsAppleMilk.java:167` `public static Block yuzuGel;`
- **インスタンス生成**: `MaterialRegister.java:1091` `new BlockYuzuLight()` / `setBlockName("defeatedcrow.lightGel")`
- **GameRegistry**: `GameRegistry.registerBlock(DCsAppleMilk.yuzuGel, "defeatedcrow.lightGel")` (`MaterialRegister.java:330`)
- **Material / Hardness / Resistance**: `Material.clay`, hardness ``, resistance `` (`BlockYuzuLight.java:1`)
...
## レンダー / モデル
- Render ID: `DCsAppleMilk.modelYuzuLight` (`DCsAppleMilk.java: - ` 初期化, `CommonProxy.getRenderID()` , `ClientProxy.registerRenderers()` で登録)
