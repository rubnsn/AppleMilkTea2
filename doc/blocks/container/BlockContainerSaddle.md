# BlockContainerSaddle

> Category: `container`  
> Source: `src/main/java/mods/defeatedcrow/common/block/container/BlockContainerSaddle.java:1`  
> Registry: `defeatedcrow.containerSaddle` (`DCsAppleMilk.containerSaddle`)  
...
## 登録情報
- **フィールド定義**: `DCsAppleMilk.java:209` `public static Block containerSaddle;`
- **インスタンス生成**: `MaterialRegister.java:916` `new BlockContainerSaddle()` / `setBlockName("defeatedcrow.containerSaddle")`
- **GameRegistry**: `GameRegistry.registerBlock(DCsAppleMilk.containerSaddle, ItemContainerBase.class, "defeatedcrow.containerSaddle")` (`MaterialRegister.java:354`)
- **Material / Hardness / Resistance**: `Material.unknown`, hardness ``, resistance `` (`BlockContainerSaddle.java:1`)
...
## レンダー / モデル
- Render ID: `DCsAppleMilk.modelContainerSaddle` (`DCsAppleMilk.java: - ` 初期化, `CommonProxy.getRenderID()` , `ClientProxy.registerRenderers()` で登録)
