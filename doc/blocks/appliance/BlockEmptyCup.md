...
> Category: `appliance`  
> Source: `src/main/java/mods/defeatedcrow/common/block/appliance/BlockEmptyCup.java:1`  
> Registry: `defeatedcrow.emptyCup` (`DCsAppleMilk.emptyCup`)  
> ItemBlock: `なし`  
> TileEntity: `なし`  
...
## 登録情報
- **フィールド定義**: `DCsAppleMilk.java:155` `public static Block emptyCup;`
- **インスタンス生成**: `MaterialRegister.java:1045` `new BlockEmptyCup()` / `setBlockName("defeatedcrow.emptyCup")`
- **GameRegistry**: `GameRegistry.registerBlock(DCsAppleMilk.emptyCup, "defeatedcrow.emptyCup")` (`MaterialRegister.java:319`)
- **Material / Hardness / Resistance**: `Material.circuits`, hardness ``, resistance `` (`BlockEmptyCup.java:1`)
...
## レンダー / モデル
- Render ID: `DCsAppleMilk.modelEmptyCup` (`DCsAppleMilk.java: - ` 初期化, `CommonProxy.getRenderID()` , `ClientProxy.registerRenderers()` で登録)
