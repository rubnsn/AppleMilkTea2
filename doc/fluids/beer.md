...
> Registry: `FluidRegistry.registerFluid(new Fluid("beer_dc"))` (`MaterialRegister.java:490` `addFluid()`)
> Field: `DCsAppleMilk.beer` (`DCsAppleMilk.java:xxx`)
> Block: `-`
> Container: `itemLargeBottle:50` / `-`
...
## 登録情報
- **Fluid**: `new Fluid("beer_dc").setDensity(...).setViscosity(...)` (`MaterialRegister.java:500`)
- **Container**: `itemLargeBottle:50` (メタ分岐) / `-`
