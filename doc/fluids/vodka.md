...
> Registry: `FluidRegistry.registerFluid(new Fluid("vodka_dc"))` (`MaterialRegister.java:490` `addFluid()`)
> Field: `DCsAppleMilk.vodka` (`DCsAppleMilk.java:xxx`)
> Block: `-`
> Container: `itemLargeBottle:54` / `-`
...
## 登録情報
- **Fluid**: `new Fluid("vodka_dc").setDensity(...).setViscosity(...)` (`MaterialRegister.java:500`)
- **Container**: `itemLargeBottle:54` (メタ分岐) / `-`
