...
> Registry: `FluidRegistry.registerFluid(new Fluid("brandy_dc"))` (`MaterialRegister.java:490` `addFluid()`)
> Field: `DCsAppleMilk.brandy` (`DCsAppleMilk.java:xxx`)
> Block: `-`
> Container: `itemLargeBottle:56` / `-`
...
## 登録情報
- **Fluid**: `new Fluid("brandy_dc").setDensity(...).setViscosity(...)` (`MaterialRegister.java:500`)
- **Container**: `itemLargeBottle:56` (メタ分岐) / `-`
