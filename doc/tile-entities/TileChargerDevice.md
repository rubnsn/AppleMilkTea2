...
> Source: `src/main/java/mods/defeatedcrow/common/tile/energy/TileChargerDevice.java:1`
> Registry: `TileChargerDevice` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileChargerDevice.class, "TileChargerDevice")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
蓄電デバイス。yuzuBat/gelBat共通。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileChargerDevice extends TileChargerBase` (`src/main/java/mods/defeatedcrow/common/tile/energy/TileChargerDevice.java:1`)
- **登録名**: `TileChargerDevice` (`GameRegistry.registerTileEntity(TileChargerDevice.class, "TileChargerDevice")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityChargerDeviceRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/energy/TileChargerDevice.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24