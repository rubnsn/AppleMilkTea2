...
> Category: `food / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCocktail2.java:1`
> Registry: `TileCocktail2` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCocktail2.class, "TileCocktail2")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
カクテル2。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCocktail2 extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileCocktail2.java:1`)
- **登録名**: `TileCocktail2` (`GameRegistry.registerTileEntity(TileCocktail2.class, "TileCocktail2")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCocktail2Renderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCocktail2.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24