...
> Category: `food / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCocktail.java:1`
> Registry: `TileCocktail` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCocktail.class, "TileCocktail")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
カクテル1。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCocktail extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileCocktail.java:1`)
- **登録名**: `TileCocktail` (`GameRegistry.registerTileEntity(TileCocktail.class, "TileCocktail")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCocktailRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCocktail.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24