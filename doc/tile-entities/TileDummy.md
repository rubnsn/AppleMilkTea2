...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileDummy.java:1`
> Registry: `TileDummy` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileDummy.class, "TileDummy")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
ダミー。プレースホルダ。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileDummy extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileDummy.java:1`)
- **登録名**: `TileDummy` (`GameRegistry.registerTileEntity(TileDummy.class, "TileDummy")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityDummyRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileDummy.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24