...
> Category: `food / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileSteak.java:1`
> Registry: `TileSteak` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileSteak.class, "TileSteak")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
ステーキ皿。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileSteak extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileSteak.java:1`)
- **登録名**: `TileSteak` (`GameRegistry.registerTileEntity(TileSteak.class, "TileSteak")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntitySteakRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileSteak.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24