...
> Category: `brewing / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileLargeBottle.java:1`
> Registry: `TileLargeBottle` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileLargeBottle.class, "TileLargeBottle")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
大瓶。メタ&15/>>4管理。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileLargeBottle extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileLargeBottle.java:1`)
- **登録名**: `TileLargeBottle` (`GameRegistry.registerTileEntity(TileLargeBottle.class, "TileLargeBottle")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityLargeBottleRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileLargeBottle.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24