...
> Category: `food / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileAlcoholCup.java:1`
> Registry: `TileAlcoholCup` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileAlcoholCup.class, "TileAlcoholCup")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
酒カップ。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileAlcoholCup extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileAlcoholCup.java:1`)
- **登録名**: `TileAlcoholCup` (`GameRegistry.registerTileEntity(TileAlcoholCup.class, "TileAlcoholCup")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityAlcoholCupRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileAlcoholCup.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24