...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TilePanHandle.java:1`
> Registry: `TilePanHandle` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TilePanHandle.class, "TilePanHandle")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
鍋ハンドル。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TilePanHandle extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TilePanHandle.java:1`)
- **登録名**: `TilePanHandle` (`GameRegistry.registerTileEntity(TilePanHandle.class, "TilePanHandle")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityPanHandleRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TilePanHandle.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24