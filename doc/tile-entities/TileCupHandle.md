...
> Category: `food / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCupHandle.java:1`
> Registry: `TileCupHandle` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCupHandle.class, "TileCupHandle")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
空カップハンドル。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCupHandle extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileCupHandle.java:1`)
- **登録名**: `TileCupHandle` (`GameRegistry.registerTileEntity(TileCupHandle.class, "TileCupHandle")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCupHandleRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCupHandle.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24