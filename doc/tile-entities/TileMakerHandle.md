...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileMakerHandle.java:1`
> Registry: `TileMakerHandle` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileMakerHandle.class, "TileMakerHandle")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
ティーメーカーハンドル。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileMakerHandle extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileMakerHandle.java:1`)
- **登録名**: `TileMakerHandle` (`GameRegistry.registerTileEntity(TileMakerHandle.class, "TileMakerHandle")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityMakerHandleRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileMakerHandle.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24