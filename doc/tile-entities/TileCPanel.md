...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCPanel.java:1`
> Registry: `TileChalcedonyPanel` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCPanel.class, "TileChalcedonyPanel")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
玉髄パネル。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCPanel extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileCPanel.java:1`)
- **登録名**: `TileChalcedonyPanel` (`GameRegistry.registerTileEntity(TileCPanel.class, "TileChalcedonyPanel")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCPanelRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCPanel.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24