...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileBowlRack.java:1`
> Registry: `TileBowlRack` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileBowlRack.class, "TileBowlRack")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
碗ラック。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileBowlRack extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileBowlRack.java:1`)
- **登録名**: `TileBowlRack` (`GameRegistry.registerTileEntity(TileBowlRack.class, "TileBowlRack")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityBowlRackRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileBowlRack.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24