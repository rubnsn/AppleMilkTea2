...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCLamp.java:1`
> Registry: `TileChalcedonyLamp` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCLamp.class, "TileChalcedonyLamp")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
玉髄ランプ。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCLamp extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileCLamp.java:1`)
- **登録名**: `TileChalcedonyLamp` (`GameRegistry.registerTileEntity(TileCLamp.class, "TileChalcedonyLamp")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCLampRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCLamp.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24