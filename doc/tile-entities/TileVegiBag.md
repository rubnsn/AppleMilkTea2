...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileVegiBag.java:1`
> Registry: `TileVegiBag` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileVegiBag.class, "TileVegiBag")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
野菜袋。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileVegiBag extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileVegiBag.java:1`)
- **登録名**: `TileVegiBag` (`GameRegistry.registerTileEntity(TileVegiBag.class, "TileVegiBag")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityVegiBagRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileVegiBag.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24