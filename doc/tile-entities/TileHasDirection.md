...
> Category: `base / 共通基底`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileHasDirection.java:1`
> Registry: `TileHasDirection` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileHasDirection.class, "TileHasDirection")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
方位保持基底。xCoord等で向き保持。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileHasDirection extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileHasDirection.java:1`)
- **登録名**: `TileHasDirection` (`GameRegistry.registerTileEntity(TileHasDirection.class, "TileHasDirection")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityHasDirectionRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileHasDirection.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24