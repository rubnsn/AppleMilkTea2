...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileWipeBox2.java:1`
> Registry: `TileWipeBox2` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileWipeBox2.class, "TileWipeBox2")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
大型紙箱。耐久0-5000。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileWipeBox2 extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileWipeBox2.java:1`)
- **登録名**: `TileWipeBox2` (`GameRegistry.registerTileEntity(TileWipeBox2.class, "TileWipeBox2")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityWipeBox2Renderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileWipeBox2.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24