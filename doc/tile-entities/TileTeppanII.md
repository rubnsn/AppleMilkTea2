...
> Source: `src/main/java/mods/defeatedcrow/common/tile/appliance/TileTeppanII.java:1`
> Registry: `TileTeppanII` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileTeppanII.class, "TileTeppanII")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
鉄板II。PlateRecipe処理。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileTeppanII extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/appliance/TileTeppanII.java:1`)
- **登録名**: `TileTeppanII` (`GameRegistry.registerTileEntity(TileTeppanII.class, "TileTeppanII")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityTeppanIIRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/appliance/TileTeppanII.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24