...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCardBoard.java:1`
> Registry: `TileCardboard` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCardBoard.class, "TileCardboard")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
段ボール。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCardBoard extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileCardBoard.java:1`)
- **登録名**: `TileCardboard` (`GameRegistry.registerTileEntity(TileCardBoard.class, "TileCardboard")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCardBoardRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCardBoard.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24