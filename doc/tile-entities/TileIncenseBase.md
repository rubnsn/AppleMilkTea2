...
> Category: `magic / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileIncenseBase.java:1`
> Registry: `TileIncenseBase` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileIncenseBase.class, "TileIncenseBase")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
お香台。IIncenseEffect処理。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileIncenseBase extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileIncenseBase.java:1`)
- **登録名**: `TileIncenseBase` (`GameRegistry.registerTileEntity(TileIncenseBase.class, "TileIncenseBase")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityIncenseBaseRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileIncenseBase.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24