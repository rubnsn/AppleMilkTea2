...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCordial.java:1`
> Registry: `TileCordial` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCordial.class, "TileCordial")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
コーディアル。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCordial extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileCordial.java:1`)
- **登録名**: `TileCordial` (`GameRegistry.registerTileEntity(TileCordial.class, "TileCordial")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCordialRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCordial.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24