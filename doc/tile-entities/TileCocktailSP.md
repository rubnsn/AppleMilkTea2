...
> Category: `food / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCocktailSP.java:1`
> Registry: `TileCocktailSP` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCocktailSP.class, "TileCocktailSP")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
カクテルSP。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCocktailSP extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileCocktailSP.java:1`)
- **登録名**: `TileCocktailSP` (`GameRegistry.registerTileEntity(TileCocktailSP.class, "TileCocktailSP")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCocktailSPRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCocktailSP.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24