...
> Category: `chalcedony / decorative`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileCrowDoll.java:1`
> Registry: `TileDCCrowDoll` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileCrowDoll.class, "TileDCCrowDoll")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
カラス人形。CoordListRegister連携。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileCrowDoll extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileCrowDoll.java:1`)
- **登録名**: `TileDCCrowDoll` (`GameRegistry.registerTileEntity(TileCrowDoll.class, "TileDCCrowDoll")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityCrowDollRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileCrowDoll.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24