...
> Category: `decorative / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileChopsticksBox.java:1`
> Registry: `TileChopsticksBox` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileChopsticksBox.class, "TileChopsticksBox")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
箸箱。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileChopsticksBox extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileChopsticksBox.java:1`)
- **登録名**: `TileChopsticksBox` (`GameRegistry.registerTileEntity(TileChopsticksBox.class, "TileChopsticksBox")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityChopsticksBoxRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileChopsticksBox.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24