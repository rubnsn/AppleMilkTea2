...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileBrewingBarrel.java:1`
> Registry: `TileBarrel` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileBrewingBarrel.class, "TileBarrel")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
醸造樽。BrewingRecipe。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileBrewingBarrel extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileBrewingBarrel.java:1`)
- **登録名**: `TileBarrel` (`GameRegistry.registerTileEntity(TileBrewingBarrel.class, "TileBarrel")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityBrewingBarrelRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileBrewingBarrel.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24