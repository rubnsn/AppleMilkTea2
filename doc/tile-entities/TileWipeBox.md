...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileWipeBox.java:1`
> Registry: `TileWipeBox` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileWipeBox.class, "TileWipeBox")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
紙箱。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileWipeBox extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileWipeBox.java:1`)
- **登録名**: `TileWipeBox` (`GameRegistry.registerTileEntity(TileWipeBox.class, "TileWipeBox")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityWipeBoxRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileWipeBox.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24