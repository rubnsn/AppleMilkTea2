...
> Category: `container / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileFlowerPot.java:1`
> Registry: `TileFlowerPot` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileFlowerPot.class, "TileFlowerPot")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
植木鉢。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileFlowerPot extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileFlowerPot.java:1`)
- **登録名**: `TileFlowerPot` (`GameRegistry.registerTileEntity(TileFlowerPot.class, "TileFlowerPot")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityFlowerPotRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileFlowerPot.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24