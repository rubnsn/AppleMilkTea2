...
> Source: `src/main/java/mods/defeatedcrow/common/tile/appliance/TileFilledSoupPan.java:1`
> Registry: `TileFilledSoupPan` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileFilledSoupPan.class, "TileFilledSoupPan")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
中身入り鍋。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileFilledSoupPan extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/appliance/TileFilledSoupPan.java:1`)
- **登録名**: `TileFilledSoupPan` (`GameRegistry.registerTileEntity(TileFilledSoupPan.class, "TileFilledSoupPan")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityFilledSoupPanRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/appliance/TileFilledSoupPan.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24