...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileBread.java:1`
> Registry: `TileBread` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileBread.class, "TileBread")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
パンかご。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileBread extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileBread.java:1`)
- **登録名**: `TileBread` (`GameRegistry.registerTileEntity(TileBread.class, "TileBread")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityBreadRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileBread.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24