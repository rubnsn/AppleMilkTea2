...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileEggs.java:1`
> Registry: `TileEggs` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileEggs.class, "TileEggs")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
卵カゴ。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileEggs extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileEggs.java:1`)
- **登録名**: `TileEggs` (`GameRegistry.registerTileEntity(TileEggs.class, "TileEggs")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityEggsRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileEggs.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24