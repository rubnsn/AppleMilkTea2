...
> Source: `src/main/java/mods/defeatedcrow/common/tile/appliance/TilePanG.java:1`
> Registry: `TilePanG` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TilePanG.class, "TilePanG")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
鍋G。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TilePanG extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/appliance/TilePanG.java:1`)
- **登録名**: `TilePanG` (`GameRegistry.registerTileEntity(TilePanG.class, "TilePanG")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityPanGRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/appliance/TilePanG.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24