...
> Category: `chalcedony / container`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileRotaryDial.java:1`
> Registry: `TileRotaryDial` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileRotaryDial.class, "TileRotaryDial")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
ロータリーダイヤル。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileRotaryDial extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileRotaryDial.java:1`)
- **登録名**: `TileRotaryDial` (`GameRegistry.registerTileEntity(TileRotaryDial.class, "TileRotaryDial")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityRotaryDialRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileRotaryDial.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24