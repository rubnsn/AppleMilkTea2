...
> Category: `food / food`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileJPBowl.java:1`
> Registry: `TileJPBowl` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileJPBowl.class, "TileJPBowl")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
和風碗。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileJPBowl extends TileHasDirection` (`src/main/java/mods/defeatedcrow/common/tile/TileJPBowl.java:1`)
- **登録名**: `TileJPBowl` (`GameRegistry.registerTileEntity(TileJPBowl.class, "TileJPBowl")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityJPBowlRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileJPBowl.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24