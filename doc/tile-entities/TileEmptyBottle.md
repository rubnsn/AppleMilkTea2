...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileEmptyBottle.java:1`
> Registry: `TileEmptyBottle` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileEmptyBottle.class, "TileEmptyBottle")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
空瓶。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileEmptyBottle extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileEmptyBottle.java:1`)
- **登録名**: `TileEmptyBottle` (`GameRegistry.registerTileEntity(TileEmptyBottle.class, "TileEmptyBottle")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityEmptyBottleRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileEmptyBottle.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24