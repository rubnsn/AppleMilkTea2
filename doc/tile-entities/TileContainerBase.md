...
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileContainerBase.java:1`
> Registry: `TileDCContainerBase` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileContainerBase.class, "TileDCContainerBase")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
コンテナ基底。WaterBottle/Saddle。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileContainerBase extends TileEntity` (`src/main/java/mods/defeatedcrow/common/tile/TileContainerBase.java:1`)
- **登録名**: `TileDCContainerBase` (`GameRegistry.registerTileEntity(TileContainerBase.class, "TileDCContainerBase")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityContainerBaseRenderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileContainerBase.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24