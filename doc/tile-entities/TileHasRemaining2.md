...
> Category: `base / 共通基底`
> Source: `src/main/java/mods/defeatedcrow/common/tile/TileHasRemain2.java:1`
> Registry: `TileHasRemaining2` (`CommonProxy.java:70` `GameRegistry.registerTileEntity(TileHasRemain2.class, "TileHasRemaining2")`)
> Block: `-` (`DCsAppleMilk.-`)
> GUI: なし (ID `-`)

## 概要
残量2保持基底。remain×2。 `CommonProxy.registerTileEntity()` で `GameRegistry.registerTileEntity` 登録。

## 登録情報
- **クラス**: `TileHasRemain2 extends TileHasRemaining` (`src/main/java/mods/defeatedcrow/common/tile/TileHasRemain2.java:1`)
- **登録名**: `TileHasRemaining2` (`GameRegistry.registerTileEntity(TileHasRemain2.class, "TileHasRemaining2")` at `CommonProxy.java:70-117`)
...
## レンダー
- Renderer: `TileEntityHasRemaining2Renderer` (ISBRH/TESR) (`ClientProxy.registerRenderers()`)
...
> 自動生成: `src/main/java/mods/defeatedcrow/common/tile/TileHasRemain2.java:1` / `CommonProxy.java:70`
> 最終更新: 2026-08-24