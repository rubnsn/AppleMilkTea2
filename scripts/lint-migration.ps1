...
Lint-Grep -Pattern "net\.minecraft\.block\.BlockContainer\b|extends BlockContainer\b|implements BlockContainer\b" -Paths $owned -Label "vanilla BlockContainer (BlockContainerBase はWT-A所有クラス名のため除外)"
